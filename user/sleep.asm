...
main(int argc, char *argv[])
{
  ...
  10:	2ba080e7          	jalr	698(ra) # 2c6 <exit>
  int t = atoi(argv[1]);
  14:	6588                	ld	a0,8(a1)
  16:	00000097          	auipc	ra,0x0
  1a:	1b4080e7          	jalr	436(ra) # 1ca <atoi>
  if(sleep(t) < 0)
  1e:	00000097          	auipc	ra,0x0
  22:	338080e7          	jalr	824(ra) # 356 <sleep>
  26:	00054763          	bltz	a0,34 <main+0x34>
	exit(1);
  exit(0);  
  2a:	4501                	li	a0,0
  2c:	00000097          	auipc	ra,0x0
  30:	29a080e7          	jalr	666(ra) # 2c6 <exit>
	exit(1);
  34:	4505                	li	a0,1
  36:	00000097          	auipc	ra,0x0
  3a:	290080e7          	jalr	656(ra) # 2c6 <exit>
...
_main()
{
  ...
  54:	276080e7          	jalr	630(ra) # 2c6 <exit>
...
gets(char *buf, int max)
{
 ...
 146:	19c080e7          	jalr	412(ra) # 2de <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a8:	17a080e7          	jalr	378(ra) # 31e <fstat>
 1ac:	892a                	mv	s2,a0
  close(fd);
 1ae:	8526                	mv	a0,s1
 1b0:	00000097          	auipc	ra,0x0
 1b4:	13e080e7          	jalr	318(ra) # 2ee <close>
  return r;
}
 1b8:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	43e50513          	addi	a0,a0,1086 # 7f8 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	372b8b93          	addi	s7,s7,882 # 7f8 <digits>
 ...
 5ca:	22a90913          	addi	s2,s2,554 # 7f0 <malloc+0xe4>
        while(*s != 0){
