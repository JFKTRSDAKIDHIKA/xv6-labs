...
forktest(void)
{
  ...
  3e:	41e50513          	addi	a0,a0,1054 # 458 <sysinfo+0xa>
  ...
  68:	40450513          	addi	a0,a0,1028 # 468 <sysinfo+0x1a>
  ...
  b8:	40450513          	addi	a0,a0,1028 # 4b8 <sysinfo+0x6a>
  ...
  d4:	3b850513          	addi	a0,a0,952 # 488 <sysinfo+0x3a>
  ...
  ee:	3b650513          	addi	a0,a0,950 # 4a0 <sysinfo+0x52>
