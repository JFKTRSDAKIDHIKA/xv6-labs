...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	10250513          	addi	a0,a0,258 # 6140 <malloc+0x106>
      46:	00006097          	auipc	ra,0x6
      4a:	f36080e7          	jalr	-202(ra) # 5f7c <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	0e050513          	addi	a0,a0,224 # 6160 <malloc+0x126>
      88:	00006097          	auipc	ra,0x6
      8c:	ef4080e7          	jalr	-268(ra) # 5f7c <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0d050513          	addi	a0,a0,208 # 6178 <malloc+0x13e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0d250513          	addi	a0,a0,210 # 6198 <malloc+0x15e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	09a50513          	addi	a0,a0,154 # 6180 <malloc+0x146>
      ee:	00006097          	auipc	ra,0x6
      f2:	e8e080e7          	jalr	-370(ra) # 5f7c <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0a650513          	addi	a0,a0,166 # 61a8 <malloc+0x16e>
     10a:	00006097          	auipc	ra,0x6
     10e:	e72080e7          	jalr	-398(ra) # 5f7c <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0a450513          	addi	a0,a0,164 # 61d0 <malloc+0x196>
     134:	00006097          	auipc	ra,0x6
     138:	b10080e7          	jalr	-1264(ra) # 5c44 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	09050513          	addi	a0,a0,144 # 61d0 <malloc+0x196>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	08c58593          	addi	a1,a1,140 # 61e0 <malloc+0x1a6>
     15c:	00006097          	auipc	ra,0x6
     160:	ab8080e7          	jalr	-1352(ra) # 5c14 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	06850513          	addi	a0,a0,104 # 61d0 <malloc+0x196>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	06c58593          	addi	a1,a1,108 # 61e8 <malloc+0x1ae>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	03c50513          	addi	a0,a0,60 # 61d0 <malloc+0x196>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	02650513          	addi	a0,a0,38 # 61f0 <malloc+0x1b6>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	daa080e7          	jalr	-598(ra) # 5f7c <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f9c50513          	addi	a0,a0,-100 # 6218 <malloc+0x1de>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f88a8a93          	addi	s5,s5,-120 # 6218 <malloc+0x1de>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f1650513          	addi	a0,a0,-234 # 6228 <malloc+0x1ee>
     31a:	00006097          	auipc	ra,0x6
     31e:	c62080e7          	jalr	-926(ra) # 5f7c <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	f1250513          	addi	a0,a0,-238 # 6248 <malloc+0x20e>
     33e:	00006097          	auipc	ra,0x6
     342:	c3e080e7          	jalr	-962(ra) # 5f7c <printf>
        exit(1);
     346:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	f0050513          	addi	a0,a0,-256 # 6260 <malloc+0x226>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	eec98993          	addi	s3,s3,-276 # 6260 <malloc+0x226>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	ea050513          	addi	a0,a0,-352 # 6260 <malloc+0x226>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	e1058593          	addi	a1,a1,-496 # 61e8 <malloc+0x1ae>
    ...
    printf("write failed\n");
     ...
     3f2:	e9250513          	addi	a0,a0,-366 # 6280 <malloc+0x246>
     3f6:	00006097          	auipc	ra,0x6
     3fa:	b86080e7          	jalr	-1146(ra) # 5f7c <printf>
    exit(1);
     3fe:	4505                	li	a0,1
     ...
     40c:	e6050513          	addi	a0,a0,-416 # 6268 <malloc+0x22e>
     410:	00006097          	auipc	ra,0x6
     414:	b6c080e7          	jalr	-1172(ra) # 5f7c <printf>
      exit(1);
     418:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     426:	e4650513          	addi	a0,a0,-442 # 6268 <malloc+0x22e>
     42a:	00006097          	auipc	ra,0x6
     42e:	b52080e7          	jalr	-1198(ra) # 5f7c <printf>
    exit(1);
     432:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     44a:	e1a50513          	addi	a0,a0,-486 # 6260 <malloc+0x226>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	d3ea0a13          	addi	s4,s4,-706 # 6290 <malloc+0x256>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	c9a50513          	addi	a0,a0,-870 # 6298 <malloc+0x25e>
     606:	00006097          	auipc	ra,0x6
     60a:	976080e7          	jalr	-1674(ra) # 5f7c <printf>
      exit(1);
     60e:	4505                	li	a0,1
     ...
     620:	c9450513          	addi	a0,a0,-876 # 62b0 <malloc+0x276>
     624:	00006097          	auipc	ra,0x6
     628:	958080e7          	jalr	-1704(ra) # 5f7c <printf>
      exit(1);
     62c:	4505                	li	a0,1
     ...
     63e:	ca650513          	addi	a0,a0,-858 # 62e0 <malloc+0x2a6>
     642:	00006097          	auipc	ra,0x6
     646:	93a080e7          	jalr	-1734(ra) # 5f7c <printf>
      exit(1);
     64a:	4505                	li	a0,1
     ...
     658:	cbc50513          	addi	a0,a0,-836 # 6310 <malloc+0x2d6>
     65c:	00006097          	auipc	ra,0x6
     660:	920080e7          	jalr	-1760(ra) # 5f7c <printf>
      exit(1);
     664:	4505                	li	a0,1
     ...
     676:	cae50513          	addi	a0,a0,-850 # 6320 <malloc+0x2e6>
     67a:	00006097          	auipc	ra,0x6
     67e:	902080e7          	jalr	-1790(ra) # 5f7c <printf>
      exit(1);
     682:	4505                	li	a0,1
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6be:	c96a0a13          	addi	s4,s4,-874 # 6350 <malloc+0x316>
    n = write(fds[1], "x", 1);
     6c2:	00006a97          	auipc	s5,0x6
     6c6:	b26a8a93          	addi	s5,s5,-1242 # 61e8 <malloc+0x1ae>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     76a:	bf250513          	addi	a0,a0,-1038 # 6358 <malloc+0x31e>
     76e:	00006097          	auipc	ra,0x6
     772:	80e080e7          	jalr	-2034(ra) # 5f7c <printf>
      exit(1);
     776:	4505                	li	a0,1
     ...
     788:	bec50513          	addi	a0,a0,-1044 # 6370 <malloc+0x336>
     78c:	00005097          	auipc	ra,0x5
     790:	7f0080e7          	jalr	2032(ra) # 5f7c <printf>
      exit(1);
     794:	4505                	li	a0,1
     ...
     7a2:	b7250513          	addi	a0,a0,-1166 # 6310 <malloc+0x2d6>
     7a6:	00005097          	auipc	ra,0x5
     7aa:	7d6080e7          	jalr	2006(ra) # 5f7c <printf>
      exit(1);
     7ae:	4505                	li	a0,1
     ...
     7bc:	be850513          	addi	a0,a0,-1048 # 63a0 <malloc+0x366>
     7c0:	00005097          	auipc	ra,0x5
     7c4:	7bc080e7          	jalr	1980(ra) # 5f7c <printf>
      exit(1);
     7c8:	4505                	li	a0,1
     ...
     7da:	be250513          	addi	a0,a0,-1054 # 63b8 <malloc+0x37e>
     7de:	00005097          	auipc	ra,0x5
     7e2:	79e080e7          	jalr	1950(ra) # 5f7c <printf>
      exit(1);
     7e6:	4505                	li	a0,1
...
00000000000007f0 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     830:	9b458593          	addi	a1,a1,-1612 # 61e0 <malloc+0x1a6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     84c:	98850513          	addi	a0,a0,-1656 # 61d0 <malloc+0x196>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     878:	95c50513          	addi	a0,a0,-1700 # 61d0 <malloc+0x196>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     88c:	94850513          	addi	a0,a0,-1720 # 61d0 <malloc+0x196>
  ...
  write(fd1, "abcdef", 6);
     ...
     8ca:	b8258593          	addi	a1,a1,-1150 # 6448 <malloc+0x40e>
     8ce:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     90c:	8c850513          	addi	a0,a0,-1848 # 61d0 <malloc+0x196>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     950:	a9c50513          	addi	a0,a0,-1380 # 63e8 <malloc+0x3ae>
     954:	00005097          	auipc	ra,0x5
     958:	628080e7          	jalr	1576(ra) # 5f7c <printf>
    exit(1);
     95c:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     96c:	aa050513          	addi	a0,a0,-1376 # 6408 <malloc+0x3ce>
     970:	00005097          	auipc	ra,0x5
     974:	60c080e7          	jalr	1548(ra) # 5f7c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     978:	8652                	mv	a2,s4
     97a:	85d6                	mv	a1,s5
     97c:	00006517          	auipc	a0,0x6
     980:	a9c50513          	addi	a0,a0,-1380 # 6418 <malloc+0x3de>
     984:	00005097          	auipc	ra,0x5
     988:	5f8080e7          	jalr	1528(ra) # 5f7c <printf>
    exit(1);
     98c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     99c:	aa050513          	addi	a0,a0,-1376 # 6438 <malloc+0x3fe>
     9a0:	00005097          	auipc	ra,0x5
     9a4:	5dc080e7          	jalr	1500(ra) # 5f7c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a8:	8652                	mv	a2,s4
     9aa:	85d6                	mv	a1,s5
     9ac:	00006517          	auipc	a0,0x6
     9b0:	a6c50513          	addi	a0,a0,-1428 # 6418 <malloc+0x3de>
     9b4:	00005097          	auipc	ra,0x5
     9b8:	5c8080e7          	jalr	1480(ra) # 5f7c <printf>
    exit(1);
     9bc:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9ce:	a8650513          	addi	a0,a0,-1402 # 6450 <malloc+0x416>
     9d2:	00005097          	auipc	ra,0x5
     9d6:	5aa080e7          	jalr	1450(ra) # 5f7c <printf>
    exit(1);
     9da:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9ec:	a8850513          	addi	a0,a0,-1400 # 6470 <malloc+0x436>
     9f0:	00005097          	auipc	ra,0x5
     9f4:	58c080e7          	jalr	1420(ra) # 5f7c <printf>
    exit(1);
     9f8:	4505                	li	a0,1
...
0000000000000a02 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a20:	a7450513          	addi	a0,a0,-1420 # 6490 <malloc+0x456>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a38:	a8498993          	addi	s3,s3,-1404 # 64b8 <malloc+0x47e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a3c:	00006a97          	auipc	s5,0x6
     a40:	ab4a8a93          	addi	s5,s5,-1356 # 64f0 <malloc+0x4b6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a86:	a0e50513          	addi	a0,a0,-1522 # 6490 <malloc+0x456>
  ...
  if(unlink("small") < 0){
     ...
     ac2:	9d250513          	addi	a0,a0,-1582 # 6490 <malloc+0x456>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     aec:	9b050513          	addi	a0,a0,-1616 # 6498 <malloc+0x45e>
     af0:	00005097          	auipc	ra,0x5
     af4:	48c080e7          	jalr	1164(ra) # 5f7c <printf>
    exit(1);
     af8:	4505                	li	a0,1
     ...
     b0a:	9c250513          	addi	a0,a0,-1598 # 64c8 <malloc+0x48e>
     b0e:	00005097          	auipc	ra,0x5
     b12:	46e080e7          	jalr	1134(ra) # 5f7c <printf>
      exit(1);
     b16:	4505                	li	a0,1
     ...
     b28:	9dc50513          	addi	a0,a0,-1572 # 6500 <malloc+0x4c6>
     b2c:	00005097          	auipc	ra,0x5
     b30:	450080e7          	jalr	1104(ra) # 5f7c <printf>
      exit(1);
     b34:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b44:	9e850513          	addi	a0,a0,-1560 # 6528 <malloc+0x4ee>
     b48:	00005097          	auipc	ra,0x5
     b4c:	434080e7          	jalr	1076(ra) # 5f7c <printf>
    exit(1);
     b50:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b60:	9ec50513          	addi	a0,a0,-1556 # 6548 <malloc+0x50e>
     b64:	00005097          	auipc	ra,0x5
     b68:	418080e7          	jalr	1048(ra) # 5f7c <printf>
    exit(1);
     b6c:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b7c:	9e850513          	addi	a0,a0,-1560 # 6560 <malloc+0x526>
     b80:	00005097          	auipc	ra,0x5
     b84:	3fc080e7          	jalr	1020(ra) # 5f7c <printf>
    exit(1);
     b88:	4505                	li	a0,1
...
0000000000000b92 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     bae:	9d650513          	addi	a0,a0,-1578 # 6580 <malloc+0x546>
  ...
  fd = open("big", O_RDONLY);
     ...
     c00:	98450513          	addi	a0,a0,-1660 # 6580 <malloc+0x546>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c48:	94450513          	addi	a0,a0,-1724 # 6588 <malloc+0x54e>
     c4c:	00005097          	auipc	ra,0x5
     c50:	330080e7          	jalr	816(ra) # 5f7c <printf>
    exit(1);
     c54:	4505                	li	a0,1
     ...
     c66:	94650513          	addi	a0,a0,-1722 # 65a8 <malloc+0x56e>
     c6a:	00005097          	auipc	ra,0x5
     c6e:	312080e7          	jalr	786(ra) # 5f7c <printf>
      exit(1);
     c72:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c82:	95250513          	addi	a0,a0,-1710 # 65d0 <malloc+0x596>
     c86:	00005097          	auipc	ra,0x5
     c8a:	2f6080e7          	jalr	758(ra) # 5f7c <printf>
    exit(1);
     c8e:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     cae:	8d650513          	addi	a0,a0,-1834 # 6580 <malloc+0x546>
     ...
     cda:	91a50513          	addi	a0,a0,-1766 # 65f0 <malloc+0x5b6>
     cde:	00005097          	auipc	ra,0x5
     ce2:	29e080e7          	jalr	670(ra) # 5f7c <printf>
        exit(1);
     ce6:	4505                	li	a0,1
     ...
     cf8:	92450513          	addi	a0,a0,-1756 # 6618 <malloc+0x5de>
     cfc:	00005097          	auipc	ra,0x5
     d00:	280080e7          	jalr	640(ra) # 5f7c <printf>
      exit(1);
     d04:	4505                	li	a0,1
     ...
     d16:	91e50513          	addi	a0,a0,-1762 # 6630 <malloc+0x5f6>
     d1a:	00005097          	auipc	ra,0x5
     d1e:	262080e7          	jalr	610(ra) # 5f7c <printf>
      exit(1);
     d22:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d32:	92a50513          	addi	a0,a0,-1750 # 6658 <malloc+0x61e>
     d36:	00005097          	auipc	ra,0x5
     d3a:	246080e7          	jalr	582(ra) # 5f7c <printf>
    exit(1);
     d3e:	4505                	li	a0,1
...
0000000000000d48 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d60:	91450513          	addi	a0,a0,-1772 # 6670 <malloc+0x636>
  ...
  write(fd, "hello", SZ);
     ...
     d78:	92c58593          	addi	a1,a1,-1748 # 66a0 <malloc+0x666>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d94:	8e050513          	addi	a0,a0,-1824 # 6670 <malloc+0x636>
  ...
  if(unlink("unlinkread") != 0){
     ...
     daa:	8ca50513          	addi	a0,a0,-1846 # 6670 <malloc+0x636>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dc0:	8b450513          	addi	a0,a0,-1868 # 6670 <malloc+0x636>
  ...
  write(fd1, "yyy", 3);
     ...
     dd4:	91858593          	addi	a1,a1,-1768 # 66e8 <malloc+0x6ae>
  ...
  unlink("unlinkread");
     ...
     e3c:	83850513          	addi	a0,a0,-1992 # 6670 <malloc+0x636>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e5c:	82850513          	addi	a0,a0,-2008 # 6680 <malloc+0x646>
     e60:	00005097          	auipc	ra,0x5
     e64:	11c080e7          	jalr	284(ra) # 5f7c <printf>
    exit(1);
     e68:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e78:	83450513          	addi	a0,a0,-1996 # 66a8 <malloc+0x66e>
     e7c:	00005097          	auipc	ra,0x5
     e80:	100080e7          	jalr	256(ra) # 5f7c <printf>
    exit(1);
     e84:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e94:	83850513          	addi	a0,a0,-1992 # 66c8 <malloc+0x68e>
     e98:	00005097          	auipc	ra,0x5
     e9c:	0e4080e7          	jalr	228(ra) # 5f7c <printf>
    exit(1);
     ea0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     eb0:	84450513          	addi	a0,a0,-1980 # 66f0 <malloc+0x6b6>
     eb4:	00005097          	auipc	ra,0x5
     eb8:	0c8080e7          	jalr	200(ra) # 5f7c <printf>
    exit(1);
     ebc:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ecc:	84850513          	addi	a0,a0,-1976 # 6710 <malloc+0x6d6>
     ed0:	00005097          	auipc	ra,0x5
     ed4:	0ac080e7          	jalr	172(ra) # 5f7c <printf>
    exit(1);
     ed8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee8:	84c50513          	addi	a0,a0,-1972 # 6730 <malloc+0x6f6>
     eec:	00005097          	auipc	ra,0x5
     ef0:	090080e7          	jalr	144(ra) # 5f7c <printf>
    exit(1);
     ef4:	4505                	li	a0,1
...
0000000000000efe <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f4c:	75858593          	addi	a1,a1,1880 # 66a0 <malloc+0x666>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f6c:	7f058593          	addi	a1,a1,2032 # 6758 <malloc+0x71e>
     f70:	00005517          	auipc	a0,0x5
     f74:	7e050513          	addi	a0,a0,2016 # 6750 <malloc+0x716>
  ...
  unlink("lf1");
     ...
     f88:	7cc50513          	addi	a0,a0,1996 # 6750 <malloc+0x716>
     f8c:	00005097          	auipc	ra,0x5
     f90:	cb8080e7          	jalr	-840(ra) # 5c44 <unlink>
  if(open("lf1", 0) >= 0){
     f94:	4581                	li	a1,0
     f96:	00005517          	auipc	a0,0x5
     f9a:	7ba50513          	addi	a0,a0,1978 # 6750 <malloc+0x716>
  ...
  fd = open("lf2", 0);
     ...
     fb0:	7ac50513          	addi	a0,a0,1964 # 6758 <malloc+0x71e>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe8:	77458593          	addi	a1,a1,1908 # 6758 <malloc+0x71e>
     fec:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ffe:	75e50513          	addi	a0,a0,1886 # 6758 <malloc+0x71e>
    1002:	00005097          	auipc	ra,0x5
    1006:	c42080e7          	jalr	-958(ra) # 5c44 <unlink>
  if(link("lf2", "lf1") >= 0){
    100a:	00005597          	auipc	a1,0x5
    100e:	74658593          	addi	a1,a1,1862 # 6750 <malloc+0x716>
    1012:	00005517          	auipc	a0,0x5
    1016:	74650513          	addi	a0,a0,1862 # 6758 <malloc+0x71e>
  ...
  if(link(".", "lf1") >= 0){
    ...
    102a:	72a58593          	addi	a1,a1,1834 # 6750 <malloc+0x716>
    102e:	00006517          	auipc	a0,0x6
    1032:	83250513          	addi	a0,a0,-1998 # 6860 <malloc+0x826>
    ...
    1054:	71050513          	addi	a0,a0,1808 # 6760 <malloc+0x726>
    1058:	00005097          	auipc	ra,0x5
    105c:	f24080e7          	jalr	-220(ra) # 5f7c <printf>
    exit(1);
    1060:	4505                	li	a0,1
    ...
    1070:	70c50513          	addi	a0,a0,1804 # 6778 <malloc+0x73e>
    1074:	00005097          	auipc	ra,0x5
    1078:	f08080e7          	jalr	-248(ra) # 5f7c <printf>
    exit(1);
    107c:	4505                	li	a0,1
    ...
    108c:	70850513          	addi	a0,a0,1800 # 6790 <malloc+0x756>
    1090:	00005097          	auipc	ra,0x5
    1094:	eec080e7          	jalr	-276(ra) # 5f7c <printf>
    exit(1);
    1098:	4505                	li	a0,1
    ...
    10a8:	70c50513          	addi	a0,a0,1804 # 67b0 <malloc+0x776>
    10ac:	00005097          	auipc	ra,0x5
    10b0:	ed0080e7          	jalr	-304(ra) # 5f7c <printf>
    exit(1);
    10b4:	4505                	li	a0,1
    ...
    10c4:	72050513          	addi	a0,a0,1824 # 67e0 <malloc+0x7a6>
    10c8:	00005097          	auipc	ra,0x5
    10cc:	eb4080e7          	jalr	-332(ra) # 5f7c <printf>
    exit(1);
    10d0:	4505                	li	a0,1
    ...
    10e0:	71c50513          	addi	a0,a0,1820 # 67f8 <malloc+0x7be>
    10e4:	00005097          	auipc	ra,0x5
    10e8:	e98080e7          	jalr	-360(ra) # 5f7c <printf>
    exit(1);
    10ec:	4505                	li	a0,1
    ...
    10fc:	71850513          	addi	a0,a0,1816 # 6810 <malloc+0x7d6>
    1100:	00005097          	auipc	ra,0x5
    1104:	e7c080e7          	jalr	-388(ra) # 5f7c <printf>
    exit(1);
    1108:	4505                	li	a0,1
    ...
    1118:	72450513          	addi	a0,a0,1828 # 6838 <malloc+0x7fe>
    111c:	00005097          	auipc	ra,0x5
    1120:	e60080e7          	jalr	-416(ra) # 5f7c <printf>
    exit(1);
    1124:	4505                	li	a0,1
    ...
    1134:	73850513          	addi	a0,a0,1848 # 6868 <malloc+0x82e>
    1138:	00005097          	auipc	ra,0x5
    113c:	e44080e7          	jalr	-444(ra) # 5f7c <printf>
    exit(1);
    1140:	4505                	li	a0,1
...
000000000000114a <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1166:	72698993          	addi	s3,s3,1830 # 6888 <malloc+0x84e>
    116a:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    11a2:	6fa50513          	addi	a0,a0,1786 # 6898 <malloc+0x85e>
    11a6:	00005097          	auipc	ra,0x5
    11aa:	dd6080e7          	jalr	-554(ra) # 5f7c <printf>
      exit(1);
    11ae:	4505                	li	a0,1
...
00000000000011b8 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1208:	6b4a0a13          	addi	s4,s4,1716 # 68b8 <malloc+0x87e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    125a:	66250513          	addi	a0,a0,1634 # 68b8 <malloc+0x87e>
  ...
  for(i = 0; i < N; i++){
    ...
    12ca:	5fa50513          	addi	a0,a0,1530 # 68c0 <malloc+0x886>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	cae080e7          	jalr	-850(ra) # 5f7c <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	5fa50513          	addi	a0,a0,1530 # 68e0 <malloc+0x8a6>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	c8e080e7          	jalr	-882(ra) # 5f7c <printf>
      exit(1);
    12f6:	4505                	li	a0,1
    ...
    1306:	5fe50513          	addi	a0,a0,1534 # 6900 <malloc+0x8c6>
    130a:	00005097          	auipc	ra,0x5
    130e:	c72080e7          	jalr	-910(ra) # 5f7c <printf>
      exit(1);
    1312:	4505                	li	a0,1
...
0000000000001354 <badarg>:
{
    ...
    1372:	e0a98993          	addi	s3,s3,-502 # 6178 <malloc+0x13e>
    argv[0] = (char*)0xffffffff;
...
000000000000139a <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13fc:	76078793          	addi	a5,a5,1888 # 7b58 <malloc+0x1b1e>
  ...
  if(pid == 0){
    ...
    1458:	12478793          	addi	a5,a5,292 # 8578 <malloc+0x253e>
    ...
    147c:	d0050513          	addi	a0,a0,-768 # 6178 <malloc+0x13e>
    ...
    1494:	51850513          	addi	a0,a0,1304 # 69a8 <malloc+0x96e>
    1498:	00005097          	auipc	ra,0x5
    149c:	ae4080e7          	jalr	-1308(ra) # 5f7c <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14b4:	47050513          	addi	a0,a0,1136 # 6920 <malloc+0x8e6>
    14b8:	00005097          	auipc	ra,0x5
    14bc:	ac4080e7          	jalr	-1340(ra) # 5f7c <printf>
    exit(1);
    14c0:	4505                	li	a0,1
    ...
    14d4:	47050513          	addi	a0,a0,1136 # 6940 <malloc+0x906>
    14d8:	00005097          	auipc	ra,0x5
    14dc:	aa4080e7          	jalr	-1372(ra) # 5f7c <printf>
    exit(1);
    14e0:	4505                	li	a0,1
    ...
    14f6:	46e50513          	addi	a0,a0,1134 # 6960 <malloc+0x926>
    14fa:	00005097          	auipc	ra,0x5
    14fe:	a82080e7          	jalr	-1406(ra) # 5f7c <printf>
    exit(1);
    1502:	4505                	li	a0,1
    ...
    1516:	47650513          	addi	a0,a0,1142 # 6988 <malloc+0x94e>
    151a:	00005097          	auipc	ra,0x5
    151e:	a62080e7          	jalr	-1438(ra) # 5f7c <printf>
    exit(1);
    1522:	4505                	li	a0,1
    ...
    1530:	8dc50513          	addi	a0,a0,-1828 # 6e08 <malloc+0xdce>
    1534:	00005097          	auipc	ra,0x5
    1538:	a48080e7          	jalr	-1464(ra) # 5f7c <printf>
    exit(1);
    153c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    157a:	45a50513          	addi	a0,a0,1114 # 69d0 <malloc+0x996>
    157e:	00005097          	auipc	ra,0x5
    1582:	9fe080e7          	jalr	-1538(ra) # 5f7c <printf>
    exit(1);
    1586:	4505                	li	a0,1
...
0000000000001590 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15ac:	c2850513          	addi	a0,a0,-984 # 61d0 <malloc+0x196>
  ...
  if(pid == 0){
    ...
    15d6:	bfea0a13          	addi	s4,s4,-1026 # 61d0 <malloc+0x196>
      int n = write(fd, "1234567890", 10);
    15da:	00005a97          	auipc	s5,0x5
    15de:	456a8a93          	addi	s5,s5,1110 # 6a30 <malloc+0x9f6>
      int fd = open("truncfile", O_WRONLY);
    15e2:	4585                	li	a1,1
    15e4:	8552                	mv	a0,s4
    ...
    164e:	3b650513          	addi	a0,a0,950 # 6a00 <malloc+0x9c6>
    1652:	00005097          	auipc	ra,0x5
    1656:	92a080e7          	jalr	-1750(ra) # 5f7c <printf>
    exit(1);
    165a:	4505                	li	a0,1
    ...
    166a:	3b250513          	addi	a0,a0,946 # 6a18 <malloc+0x9de>
    166e:	00005097          	auipc	ra,0x5
    1672:	90e080e7          	jalr	-1778(ra) # 5f7c <printf>
        exit(1);
    1676:	4505                	li	a0,1
    ...
    1688:	3bc50513          	addi	a0,a0,956 # 6a40 <malloc+0xa06>
    168c:	00005097          	auipc	ra,0x5
    1690:	8f0080e7          	jalr	-1808(ra) # 5f7c <printf>
        exit(1);
    1694:	4505                	li	a0,1
    ...
    16a6:	b2ea0a13          	addi	s4,s4,-1234 # 61d0 <malloc+0x196>
    int n = write(fd, "xxx", 3);
    16aa:	00005a97          	auipc	s5,0x5
    16ae:	3b6a8a93          	addi	s5,s5,950 # 6a60 <malloc+0xa26>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f8:	adc50513          	addi	a0,a0,-1316 # 61d0 <malloc+0x196>
  ...
  exit(xstatus);
    ...
    1716:	30650513          	addi	a0,a0,774 # 6a18 <malloc+0x9de>
    171a:	00005097          	auipc	ra,0x5
    171e:	862080e7          	jalr	-1950(ra) # 5f7c <printf>
      exit(1);
    1722:	4505                	li	a0,1
    ...
    1734:	33850513          	addi	a0,a0,824 # 6a68 <malloc+0xa2e>
    1738:	00005097          	auipc	ra,0x5
    173c:	844080e7          	jalr	-1980(ra) # 5f7c <printf>
      exit(1);
    1740:	4505                	li	a0,1
...
000000000000174a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    175c:	a2078793          	addi	a5,a5,-1504 # 6178 <malloc+0x13e>
    1760:	fcf43023          	sd	a5,-64(s0)
    1764:	00005797          	auipc	a5,0x5
    1768:	32478793          	addi	a5,a5,804 # 6a88 <malloc+0xa4e>
    176c:	fcf43423          	sd	a5,-56(s0)
    1770:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1774:	00005517          	auipc	a0,0x5
    1778:	31c50513          	addi	a0,a0,796 # 6a90 <malloc+0xa56>
  ...
  if(pid == 0) {
    ...
    17a6:	2ee50513          	addi	a0,a0,750 # 6a90 <malloc+0xa56>
    ...
    17c2:	2f250513          	addi	a0,a0,754 # 6ab0 <malloc+0xa76>
    17c6:	00004097          	auipc	ra,0x4
    17ca:	7b6080e7          	jalr	1974(ra) # 5f7c <printf>
      exit(1);
    17ce:	4505                	li	a0,1
    ...
    17de:	22650513          	addi	a0,a0,550 # 6a00 <malloc+0x9c6>
    17e2:	00004097          	auipc	ra,0x4
    17e6:	79a080e7          	jalr	1946(ra) # 5f7c <printf>
     exit(1);
    17ea:	4505                	li	a0,1
    ...
    17fa:	2a250513          	addi	a0,a0,674 # 6a98 <malloc+0xa5e>
    17fe:	00004097          	auipc	ra,0x4
    1802:	77e080e7          	jalr	1918(ra) # 5f7c <printf>
      exit(1);
    1806:	4505                	li	a0,1
    ...
    1818:	96450513          	addi	a0,a0,-1692 # 6178 <malloc+0x13e>
  ...
  if(xstatus != 0)
    ...
    184c:	27850513          	addi	a0,a0,632 # 6ac0 <malloc+0xa86>
    1850:	00004097          	auipc	ra,0x4
    1854:	72c080e7          	jalr	1836(ra) # 5f7c <printf>
      exit(1);
    1858:	4505                	li	a0,1
    ...
    1868:	27450513          	addi	a0,a0,628 # 6ad8 <malloc+0xa9e>
    186c:	00004097          	auipc	ra,0x4
    1870:	710080e7          	jalr	1808(ra) # 5f7c <printf>
    1874:	b7d1                	j	1838 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1876:	4581                	li	a1,0
    1878:	00005517          	auipc	a0,0x5
    187c:	21850513          	addi	a0,a0,536 # 6a90 <malloc+0xa56>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18a6:	ca650513          	addi	a0,a0,-858 # 6548 <malloc+0x50e>
    18aa:	00004097          	auipc	ra,0x4
    18ae:	6d2080e7          	jalr	1746(ra) # 5f7c <printf>
    exit(1);
    18b2:	4505                	li	a0,1
    ...
    18c2:	15a50513          	addi	a0,a0,346 # 6a18 <malloc+0x9de>
    18c6:	00004097          	auipc	ra,0x4
    18ca:	6b6080e7          	jalr	1718(ra) # 5f7c <printf>
    exit(1);
    18ce:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18dc:	1b850513          	addi	a0,a0,440 # 6a90 <malloc+0xa56>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1906:	1ee50513          	addi	a0,a0,494 # 6af0 <malloc+0xab6>
    190a:	00004097          	auipc	ra,0x4
    190e:	672080e7          	jalr	1650(ra) # 5f7c <printf>
    exit(1);
    1912:	4505                	li	a0,1
...
0000000000001926 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c8:	14450513          	addi	a0,a0,324 # 6b08 <malloc+0xace>
    19cc:	00004097          	auipc	ra,0x4
    19d0:	5b0080e7          	jalr	1456(ra) # 5f7c <printf>
    exit(1);
    19d4:	4505                	li	a0,1
    ...
    1a02:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x93>
{
    ...
    1a4e:	0d650513          	addi	a0,a0,214 # 6b20 <malloc+0xae6>
    1a52:	00004097          	auipc	ra,0x4
    1a56:	52a080e7          	jalr	1322(ra) # 5f7c <printf>
        exit(1);
    1a5a:	4505                	li	a0,1
    ...
    1a6a:	0d250513          	addi	a0,a0,210 # 6b38 <malloc+0xafe>
    1a6e:	00004097          	auipc	ra,0x4
    1a72:	50e080e7          	jalr	1294(ra) # 5f7c <printf>
}
    ...
    1a9c:	0b850513          	addi	a0,a0,184 # 6b50 <malloc+0xb16>
    1aa0:	00004097          	auipc	ra,0x4
    1aa4:	4dc080e7          	jalr	1244(ra) # 5f7c <printf>
      exit(1);
    1aa8:	4505                	li	a0,1
    ...
    1adc:	09850513          	addi	a0,a0,152 # 6b70 <malloc+0xb36>
    1ae0:	00004097          	auipc	ra,0x4
    1ae4:	49c080e7          	jalr	1180(ra) # 5f7c <printf>
    exit(1);
    1ae8:	4505                	li	a0,1
...
0000000000001af2 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b4e:	eb650513          	addi	a0,a0,-330 # 6a00 <malloc+0x9c6>
    1b52:	00004097          	auipc	ra,0x4
    1b56:	42a080e7          	jalr	1066(ra) # 5f7c <printf>
      exit(1);
    1b5a:	4505                	li	a0,1
    ...
    1b6a:	02250513          	addi	a0,a0,34 # 6b88 <malloc+0xb4e>
    1b6e:	00004097          	auipc	ra,0x4
    1b72:	40e080e7          	jalr	1038(ra) # 5f7c <printf>
        exit(1);
    1b76:	4505                	li	a0,1
    ...
    1b86:	01e50513          	addi	a0,a0,30 # 6ba0 <malloc+0xb66>
    1b8a:	00004097          	auipc	ra,0x4
    1b8e:	3f2080e7          	jalr	1010(ra) # 5f7c <printf>
        exit(1);
    1b92:	4505                	li	a0,1
...
0000000000001ba6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bfe:	e0650513          	addi	a0,a0,-506 # 6a00 <malloc+0x9c6>
    1c02:	00004097          	auipc	ra,0x4
    1c06:	37a080e7          	jalr	890(ra) # 5f7c <printf>
      exit(1);
    1c0a:	4505                	li	a0,1
    ...
    1c22:	de250513          	addi	a0,a0,-542 # 6a00 <malloc+0x9c6>
    1c26:	00004097          	auipc	ra,0x4
    1c2a:	356080e7          	jalr	854(ra) # 5f7c <printf>
        exit(1);
    1c2e:	4505                	li	a0,1
...
0000000000001c40 <forkfork>:
{
    ...
    1c9c:	f2850513          	addi	a0,a0,-216 # 6bc0 <malloc+0xb86>
    1ca0:	00004097          	auipc	ra,0x4
    1ca4:	2dc080e7          	jalr	732(ra) # 5f7c <printf>
      exit(1);
    1ca8:	4505                	li	a0,1
    ...
    1cae:	f4a080e7          	jalr	-182(ra) # 5bf4 <exit>
{
    ...
    1cf4:	ee050513          	addi	a0,a0,-288 # 6bd0 <malloc+0xb96>
    1cf8:	00004097          	auipc	ra,0x4
    1cfc:	284080e7          	jalr	644(ra) # 5f7c <printf>
      exit(1);
    1d00:	4505                	li	a0,1
...
0000000000001d0a <reparent2>:
{
  ...
  exit(0);
    ...
    1d42:	0ca50513          	addi	a0,a0,202 # 6e08 <malloc+0xdce>
    1d46:	00004097          	auipc	ra,0x4
    1d4a:	236080e7          	jalr	566(ra) # 5f7c <printf>
      exit(1);
    1d4e:	4505                	li	a0,1
...
0000000000001d72 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1de0:	02c50513          	addi	a0,a0,44 # 6e08 <malloc+0xdce>
    1de4:	00004097          	auipc	ra,0x4
    1de8:	198080e7          	jalr	408(ra) # 5f7c <printf>
      exit(1);
    1dec:	4505                	li	a0,1
    ...
    1e0c:	c9050513          	addi	a0,a0,-880 # 6a98 <malloc+0xa5e>
    1e10:	00004097          	auipc	ra,0x4
    1e14:	16c080e7          	jalr	364(ra) # 5f7c <printf>
          exit(1);
    1e18:	4505                	li	a0,1
    ...
    1e7e:	d7650513          	addi	a0,a0,-650 # 6bf0 <malloc+0xbb6>
    1e82:	00004097          	auipc	ra,0x4
    1e86:	0fa080e7          	jalr	250(ra) # 5f7c <printf>
            exit(1);
    1e8a:	4505                	li	a0,1
    ...
    1eb2:	d5a50513          	addi	a0,a0,-678 # 6c08 <malloc+0xbce>
    1eb6:	00004097          	auipc	ra,0x4
    1eba:	0c6080e7          	jalr	198(ra) # 5f7c <printf>
        exit(1);
    1ebe:	4505                	li	a0,1
    ...
    1f18:	d1c50513          	addi	a0,a0,-740 # 6c30 <malloc+0xbf6>
    1f1c:	00004097          	auipc	ra,0x4
    1f20:	060080e7          	jalr	96(ra) # 5f7c <printf>
        exit(1);
    1f24:	4505                	li	a0,1
...
0000000000001f98 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb8:	23450513          	addi	a0,a0,564 # 61e8 <malloc+0x1ae>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ff4:	1f8a8a93          	addi	s5,s5,504 # 61e8 <malloc+0x1ae>
      link("cat", "x");
    1ff8:	00005b97          	auipc	s7,0x5
    1ffc:	c60b8b93          	addi	s7,s7,-928 # 6c58 <malloc+0xc1e>
    2000:	a825                	j	2038 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2002:	85a6                	mv	a1,s1
    2004:	00005517          	auipc	a0,0x5
    2008:	9fc50513          	addi	a0,a0,-1540 # 6a00 <malloc+0x9c6>
    200c:	00004097          	auipc	ra,0x4
    2010:	f70080e7          	jalr	-144(ra) # 5f7c <printf>
    exit(1);
    2014:	4505                	li	a0,1
...
000000000000209a <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ca:	bb250513          	addi	a0,a0,-1102 # 6c78 <malloc+0xc3e>
    20ce:	00004097          	auipc	ra,0x4
    20d2:	eae080e7          	jalr	-338(ra) # 5f7c <printf>
    exit(1);
    20d6:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    212c:	b3850513          	addi	a0,a0,-1224 # 6c60 <malloc+0xc26>
    2130:	00004097          	auipc	ra,0x4
    2134:	e4c080e7          	jalr	-436(ra) # 5f7c <printf>
    exit(1);
    2138:	4505                	li	a0,1
    ...
    2148:	b5c50513          	addi	a0,a0,-1188 # 6ca0 <malloc+0xc66>
    214c:	00004097          	auipc	ra,0x4
    2150:	e30080e7          	jalr	-464(ra) # 5f7c <printf>
      exit(1);
    2154:	4505                	li	a0,1
    ...
    2164:	b5850513          	addi	a0,a0,-1192 # 6cb8 <malloc+0xc7e>
    2168:	00004097          	auipc	ra,0x4
    216c:	e14080e7          	jalr	-492(ra) # 5f7c <printf>
    exit(1);
    2170:	4505                	li	a0,1
...
000000000000217a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21e4:	82050513          	addi	a0,a0,-2016 # 6a00 <malloc+0x9c6>
    21e8:	00004097          	auipc	ra,0x4
    21ec:	d94080e7          	jalr	-620(ra) # 5f7c <printf>
      exit(1);
    21f0:	4505                	li	a0,1
    ...
    2206:	ace50513          	addi	a0,a0,-1330 # 6cd0 <malloc+0xc96>
    220a:	00004097          	auipc	ra,0x4
    220e:	d72080e7          	jalr	-654(ra) # 5f7c <printf>
      exit(1);
    2212:	4505                	li	a0,1
...
0000000000002226 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2288:	77c50513          	addi	a0,a0,1916 # 6a00 <malloc+0x9c6>
    228c:	00004097          	auipc	ra,0x4
    2290:	cf0080e7          	jalr	-784(ra) # 5f7c <printf>
      exit(1);
    2294:	4505                	li	a0,1
    ...
    22b4:	a4050513          	addi	a0,a0,-1472 # 6cf0 <malloc+0xcb6>
    22b8:	00004097          	auipc	ra,0x4
    22bc:	cc4080e7          	jalr	-828(ra) # 5f7c <printf>
      exit(1);
    22c0:	4505                	li	a0,1
...
00000000000022d4 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22e4:	a2850513          	addi	a0,a0,-1496 # 6d08 <malloc+0xcce>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2316:	9f650513          	addi	a0,a0,-1546 # 6d08 <malloc+0xcce>
  ...
  close(fd);
    ...
    234c:	9d070713          	addi	a4,a4,-1584 # 6d18 <malloc+0xcde>
    ...
    23a0:	a5c50513          	addi	a0,a0,-1444 # 6df8 <malloc+0xdbe>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	bd8080e7          	jalr	-1064(ra) # 5f7c <printf>
    exit(1);
    23ac:	4505                	li	a0,1
    ...
    23c4:	a5850513          	addi	a0,a0,-1448 # 6e18 <malloc+0xdde>
    23c8:	00004097          	auipc	ra,0x4
    23cc:	bb4080e7          	jalr	-1100(ra) # 5f7c <printf>
    exit(1);
    23d0:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2422:	a1a50513          	addi	a0,a0,-1510 # 6e38 <malloc+0xdfe>
    2426:	00004097          	auipc	ra,0x4
    242a:	b56080e7          	jalr	-1194(ra) # 5f7c <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243e:	5c650513          	addi	a0,a0,1478 # 6a00 <malloc+0x9c6>
    2442:	00004097          	auipc	ra,0x4
    2446:	b3a080e7          	jalr	-1222(ra) # 5f7c <printf>
    exit(1);
    244a:	4505                	li	a0,1
...
000000000000245e <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24ac:	55850513          	addi	a0,a0,1368 # 6a00 <malloc+0x9c6>
    24b0:	00004097          	auipc	ra,0x4
    24b4:	acc080e7          	jalr	-1332(ra) # 5f7c <printf>
    exit(1);
    24b8:	4505                	li	a0,1
...
00000000000024cc <manywrites>:
{
  ...
  exit(0);
    ...
    2528:	8e450513          	addi	a0,a0,-1820 # 6e08 <malloc+0xdce>
    252c:	00004097          	auipc	ra,0x4
    2530:	a50080e7          	jalr	-1456(ra) # 5f7c <printf>
      exit(1);
    2534:	4505                	li	a0,1
    ...
    25d8:	88c50513          	addi	a0,a0,-1908 # 6e60 <malloc+0xe26>
    25dc:	00004097          	auipc	ra,0x4
    25e0:	9a0080e7          	jalr	-1632(ra) # 5f7c <printf>
            exit(1);
    25e4:	4505                	li	a0,1
    ...
    25f8:	c5450513          	addi	a0,a0,-940 # 6248 <malloc+0x20e>
    25fc:	00004097          	auipc	ra,0x4
    2600:	980080e7          	jalr	-1664(ra) # 5f7c <printf>
            exit(1);
    2604:	4505                	li	a0,1
...
0000000000002616 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2690:	4cc78793          	addi	a5,a5,1228 # 7b58 <malloc+0x1b1e>
  ...
  if(ret != -1){
    ...
    26d2:	7aa50513          	addi	a0,a0,1962 # 6e78 <malloc+0xe3e>
    26d6:	00004097          	auipc	ra,0x4
    26da:	8a6080e7          	jalr	-1882(ra) # 5f7c <printf>
    exit(1);
    26de:	4505                	li	a0,1
    ...
    26f0:	23450513          	addi	a0,a0,564 # 6920 <malloc+0x8e6>
    26f4:	00004097          	auipc	ra,0x4
    26f8:	888080e7          	jalr	-1912(ra) # 5f7c <printf>
    exit(1);
    26fc:	4505                	li	a0,1
    ...
    270e:	23650513          	addi	a0,a0,566 # 6940 <malloc+0x906>
    2712:	00004097          	auipc	ra,0x4
    2716:	86a080e7          	jalr	-1942(ra) # 5f7c <printf>
    exit(1);
    271a:	4505                	li	a0,1
    ...
    272e:	23650513          	addi	a0,a0,566 # 6960 <malloc+0x926>
    2732:	00004097          	auipc	ra,0x4
    2736:	84a080e7          	jalr	-1974(ra) # 5f7c <printf>
    exit(1);
    273a:	4505                	li	a0,1
    ...
    274c:	24050513          	addi	a0,a0,576 # 6988 <malloc+0x94e>
    2750:	00004097          	auipc	ra,0x4
    2754:	82c080e7          	jalr	-2004(ra) # 5f7c <printf>
    exit(1);
    2758:	4505                	li	a0,1
...
0000000000002762 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2798:	72450513          	addi	a0,a0,1828 # 6eb8 <malloc+0xe7e>
  ...
  if(n >= 0){
    ...
    27ca:	71250513          	addi	a0,a0,1810 # 6ed8 <malloc+0xe9e>
    27ce:	00003097          	auipc	ra,0x3
    27d2:	7ae080e7          	jalr	1966(ra) # 5f7c <printf>
    exit(1);
    27d6:	4505                	li	a0,1
    ...
    27e4:	6a050513          	addi	a0,a0,1696 # 6e80 <malloc+0xe46>
    27e8:	00003097          	auipc	ra,0x3
    27ec:	794080e7          	jalr	1940(ra) # 5f7c <printf>
    exit(1);
    27f0:	4505                	li	a0,1
    ...
    27fe:	69e50513          	addi	a0,a0,1694 # 6e98 <malloc+0xe5e>
    2802:	00003097          	auipc	ra,0x3
    2806:	77a080e7          	jalr	1914(ra) # 5f7c <printf>
    exit(1);
    280a:	4505                	li	a0,1
    ...
    2818:	6ac50513          	addi	a0,a0,1708 # 6ec0 <malloc+0xe86>
    281c:	00003097          	auipc	ra,0x3
    2820:	760080e7          	jalr	1888(ra) # 5f7c <printf>
    exit(1);
    2824:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    283c:	68050513          	addi	a0,a0,1664 # 6eb8 <malloc+0xe7e>
    2840:	00003097          	auipc	ra,0x3
    2844:	404080e7          	jalr	1028(ra) # 5c44 <unlink>
  fd = open("README", O_RDONLY);
    2848:	4581                	li	a1,0
    284a:	00004517          	auipc	a0,0x4
    284e:	b0650513          	addi	a0,a0,-1274 # 6350 <malloc+0x316>
  ...
  if(n >= 0){
    ...
    2878:	69450513          	addi	a0,a0,1684 # 6f08 <malloc+0xece>
    287c:	00003097          	auipc	ra,0x3
    2880:	700080e7          	jalr	1792(ra) # 5f7c <printf>
    exit(1);
    2884:	4505                	li	a0,1
    ...
    2892:	63250513          	addi	a0,a0,1586 # 6ec0 <malloc+0xe86>
    2896:	00003097          	auipc	ra,0x3
    289a:	6e6080e7          	jalr	1766(ra) # 5f7c <printf>
    exit(1);
    289e:	4505                	li	a0,1
...
00000000000028bc <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2912:	62250513          	addi	a0,a0,1570 # 6f30 <malloc+0xef6>
    2916:	00003097          	auipc	ra,0x3
    291a:	666080e7          	jalr	1638(ra) # 5f7c <printf>
    exit(1);
    291e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2964:	5f050513          	addi	a0,a0,1520 # 6f50 <malloc+0xf16>
    2968:	00003097          	auipc	ra,0x3
    296c:	614080e7          	jalr	1556(ra) # 5f7c <printf>
    exit(1);
    2970:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29c8:	5ec50513          	addi	a0,a0,1516 # 6fb0 <malloc+0xf76>
    29cc:	00003097          	auipc	ra,0x3
    29d0:	5b0080e7          	jalr	1456(ra) # 5f7c <printf>
    exit(1);
    29d4:	4505                	li	a0,1
    ...
    29ea:	58a50513          	addi	a0,a0,1418 # 6f70 <malloc+0xf36>
    29ee:	00003097          	auipc	ra,0x3
    29f2:	58e080e7          	jalr	1422(ra) # 5f7c <printf>
      exit(1);
    29f6:	4505                	li	a0,1
    ...
    2a06:	58e50513          	addi	a0,a0,1422 # 6f90 <malloc+0xf56>
    2a0a:	00003097          	auipc	ra,0x3
    2a0e:	572080e7          	jalr	1394(ra) # 5f7c <printf>
    exit(1);
    2a12:	4505                	li	a0,1
...
0000000000002a42 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b50:	48450513          	addi	a0,a0,1156 # 6fd0 <malloc+0xf96>
    2b54:	00003097          	auipc	ra,0x3
    2b58:	428080e7          	jalr	1064(ra) # 5f7c <printf>
    exit(1);
    2b5c:	4505                	li	a0,1
    ...
    2b6c:	4b050513          	addi	a0,a0,1200 # 7018 <malloc+0xfde>
    2b70:	00003097          	auipc	ra,0x3
    2b74:	40c080e7          	jalr	1036(ra) # 5f7c <printf>
    exit(1);
    2b78:	4505                	li	a0,1
    ...
    2b8c:	4b050513          	addi	a0,a0,1200 # 7038 <malloc+0xffe>
    2b90:	00003097          	auipc	ra,0x3
    2b94:	3ec080e7          	jalr	1004(ra) # 5f7c <printf>
    exit(1);
    2b98:	4505                	li	a0,1
    ...
    2bac:	4d050513          	addi	a0,a0,1232 # 7078 <malloc+0x103e>
    2bb0:	00003097          	auipc	ra,0x3
    2bb4:	3cc080e7          	jalr	972(ra) # 5f7c <printf>
    exit(1);
    2bb8:	4505                	li	a0,1
    ...
    2bc8:	4e450513          	addi	a0,a0,1252 # 70a8 <malloc+0x106e>
    2bcc:	00003097          	auipc	ra,0x3
    2bd0:	3b0080e7          	jalr	944(ra) # 5f7c <printf>
    exit(1);
    2bd4:	4505                	li	a0,1
    ...
    2be8:	4fc50513          	addi	a0,a0,1276 # 70e0 <malloc+0x10a6>
    2bec:	00003097          	auipc	ra,0x3
    2bf0:	390080e7          	jalr	912(ra) # 5f7c <printf>
    exit(1);
    2bf4:	4505                	li	a0,1
...
0000000000002bfe <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c22:	4ea50513          	addi	a0,a0,1258 # 7108 <malloc+0x10ce>
    2c26:	00003097          	auipc	ra,0x3
    2c2a:	00e080e7          	jalr	14(ra) # 5c34 <open>
    2c2e:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c30:	00004517          	auipc	a0,0x4
    2c34:	4d850513          	addi	a0,a0,1240 # 7108 <malloc+0x10ce>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c88:	48c50513          	addi	a0,a0,1164 # 7110 <malloc+0x10d6>
    2c8c:	00003097          	auipc	ra,0x3
    2c90:	2f0080e7          	jalr	752(ra) # 5f7c <printf>
    exit(1);
    2c94:	4505                	li	a0,1
    ...
    2ca4:	48850513          	addi	a0,a0,1160 # 7128 <malloc+0x10ee>
    2ca8:	00003097          	auipc	ra,0x3
    2cac:	2d4080e7          	jalr	724(ra) # 5f7c <printf>
    exit(1);
    2cb0:	4505                	li	a0,1
    ...
    2cc0:	e4c50513          	addi	a0,a0,-436 # 6b08 <malloc+0xace>
    2cc4:	00003097          	auipc	ra,0x3
    2cc8:	2b8080e7          	jalr	696(ra) # 5f7c <printf>
    exit(1);
    2ccc:	4505                	li	a0,1
...
0000000000002cd6 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cea:	45a50513          	addi	a0,a0,1114 # 7140 <malloc+0x1106>
  ...
  close(fd);
    ...
    2d32:	cea50513          	addi	a0,a0,-790 # 6a18 <malloc+0x9de>
    2d36:	00003097          	auipc	ra,0x3
    2d3a:	246080e7          	jalr	582(ra) # 5f7c <printf>
    exit(1);
    2d3e:	4505                	li	a0,1
...
0000000000002d48 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d80:	08c50513          	addi	a0,a0,140 # 6e08 <malloc+0xdce>
    2d84:	00003097          	auipc	ra,0x3
    2d88:	1f8080e7          	jalr	504(ra) # 5f7c <printf>
    exit(1);
    2d8c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dd6:	03650513          	addi	a0,a0,54 # 6e08 <malloc+0xdce>
    2dda:	00003097          	auipc	ra,0x3
    2dde:	1a2080e7          	jalr	418(ra) # 5f7c <printf>
    exit(1);
    2de2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e36:	fd650513          	addi	a0,a0,-42 # 6e08 <malloc+0xdce>
    2e3a:	00003097          	auipc	ra,0x3
    2e3e:	142080e7          	jalr	322(ra) # 5f7c <printf>
    exit(1);
    2e42:	4505                	li	a0,1
...
0000000000002f68 <execout>:
{
  ...
  exit(0);
    ...
    2faa:	e6250513          	addi	a0,a0,-414 # 6e08 <malloc+0xdce>
    2fae:	00003097          	auipc	ra,0x3
    2fb2:	fce080e7          	jalr	-50(ra) # 5f7c <printf>
      exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2ffe:	17e50513          	addi	a0,a0,382 # 6178 <malloc+0x13e>
    3002:	faa43c23          	sd	a0,-72(s0)
    3006:	00003797          	auipc	a5,0x3
    300a:	1e278793          	addi	a5,a5,482 # 61e8 <malloc+0x1ae>
...
000000000000302c <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    303c:	2e050513          	addi	a0,a0,736 # 7318 <malloc+0x12de>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    304e:	12650513          	addi	a0,a0,294 # 7170 <malloc+0x1136>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3064:	16850513          	addi	a0,a0,360 # 71c8 <malloc+0x118e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3082:	1c250513          	addi	a0,a0,450 # 7240 <malloc+0x1206>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    309e:	21650513          	addi	a0,a0,534 # 72b0 <malloc+0x1276>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30b0:	25c50513          	addi	a0,a0,604 # 7308 <malloc+0x12ce>
  ...
  unlink("12345678901234");
    ...
    312e:	01e50513          	addi	a0,a0,30 # 7148 <malloc+0x110e>
    3132:	00003097          	auipc	ra,0x3
    3136:	e4a080e7          	jalr	-438(ra) # 5f7c <printf>
    exit(1);
    313a:	4505                	li	a0,1
    ...
    314a:	04a50513          	addi	a0,a0,74 # 7190 <malloc+0x1156>
    314e:	00003097          	auipc	ra,0x3
    3152:	e2e080e7          	jalr	-466(ra) # 5f7c <printf>
    exit(1);
    3156:	4505                	li	a0,1
    ...
    3166:	09650513          	addi	a0,a0,150 # 71f8 <malloc+0x11be>
    316a:	00003097          	auipc	ra,0x3
    316e:	e12080e7          	jalr	-494(ra) # 5f7c <printf>
    exit(1);
    3172:	4505                	li	a0,1
    ...
    3182:	0f250513          	addi	a0,a0,242 # 7270 <malloc+0x1236>
    3186:	00003097          	auipc	ra,0x3
    318a:	df6080e7          	jalr	-522(ra) # 5f7c <printf>
    exit(1);
    318e:	4505                	li	a0,1
    ...
    319e:	13650513          	addi	a0,a0,310 # 72d0 <malloc+0x1296>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	dda080e7          	jalr	-550(ra) # 5f7c <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	17250513          	addi	a0,a0,370 # 7328 <malloc+0x12ee>
    31be:	00003097          	auipc	ra,0x3
    31c2:	dbe080e7          	jalr	-578(ra) # 5f7c <printf>
    exit(1);
    31c6:	4505                	li	a0,1
...
00000000000031d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    320a:	15a50513          	addi	a0,a0,346 # 7360 <malloc+0x1326>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    323a:	13a50513          	addi	a0,a0,314 # 7370 <malloc+0x1336>
    323e:	00003097          	auipc	ra,0x3
    3242:	d3e080e7          	jalr	-706(ra) # 5f7c <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32c8:	09c50513          	addi	a0,a0,156 # 7360 <malloc+0x1326>
  ...
  unlink("diskfulldir");
    ...
    32dc:	08850513          	addi	a0,a0,136 # 7360 <malloc+0x1326>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    3414:	f8050513          	addi	a0,a0,-128 # 7390 <malloc+0x1356>
    3418:	00003097          	auipc	ra,0x3
    341c:	b64080e7          	jalr	-1180(ra) # 5f7c <printf>
...
0000000000003422 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3432:	f9250513          	addi	a0,a0,-110 # 73c0 <malloc+0x1386>
  ...
  if(chdir("iputdir") < 0){
    ...
    3446:	f7e50513          	addi	a0,a0,-130 # 73c0 <malloc+0x1386>
  ...
  if(unlink("../iputdir") < 0){
    ...
    345a:	faa50513          	addi	a0,a0,-86 # 7400 <malloc+0x13c6>
  ...
  if(chdir("/") < 0){
    ...
    346e:	fc650513          	addi	a0,a0,-58 # 7430 <malloc+0x13f6>
    ...
    348e:	f3e50513          	addi	a0,a0,-194 # 73c8 <malloc+0x138e>
    3492:	00003097          	auipc	ra,0x3
    3496:	aea080e7          	jalr	-1302(ra) # 5f7c <printf>
    exit(1);
    349a:	4505                	li	a0,1
    ...
    34aa:	f3a50513          	addi	a0,a0,-198 # 73e0 <malloc+0x13a6>
    34ae:	00003097          	auipc	ra,0x3
    34b2:	ace080e7          	jalr	-1330(ra) # 5f7c <printf>
    exit(1);
    34b6:	4505                	li	a0,1
    ...
    34c6:	f4e50513          	addi	a0,a0,-178 # 7410 <malloc+0x13d6>
    34ca:	00003097          	auipc	ra,0x3
    34ce:	ab2080e7          	jalr	-1358(ra) # 5f7c <printf>
    exit(1);
    34d2:	4505                	li	a0,1
    ...
    34e2:	f5a50513          	addi	a0,a0,-166 # 7438 <malloc+0x13fe>
    34e6:	00003097          	auipc	ra,0x3
    34ea:	a96080e7          	jalr	-1386(ra) # 5f7c <printf>
    exit(1);
    34ee:	4505                	li	a0,1
...
00000000000034f8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3516:	eae50513          	addi	a0,a0,-338 # 73c0 <malloc+0x1386>
    ...
    352a:	e9a50513          	addi	a0,a0,-358 # 73c0 <malloc+0x1386>
    ...
    353e:	ec650513          	addi	a0,a0,-314 # 7400 <malloc+0x13c6>
    ...
    355e:	4a650513          	addi	a0,a0,1190 # 6a00 <malloc+0x9c6>
    3562:	00003097          	auipc	ra,0x3
    3566:	a1a080e7          	jalr	-1510(ra) # 5f7c <printf>
    exit(1);
    356a:	4505                	li	a0,1
    ...
    357a:	e5250513          	addi	a0,a0,-430 # 73c8 <malloc+0x138e>
    357e:	00003097          	auipc	ra,0x3
    3582:	9fe080e7          	jalr	-1538(ra) # 5f7c <printf>
      exit(1);
    3586:	4505                	li	a0,1
    ...
    3596:	ebe50513          	addi	a0,a0,-322 # 7450 <malloc+0x1416>
    359a:	00003097          	auipc	ra,0x3
    359e:	9e2080e7          	jalr	-1566(ra) # 5f7c <printf>
      exit(1);
    35a2:	4505                	li	a0,1
    ...
    35b2:	e6250513          	addi	a0,a0,-414 # 7410 <malloc+0x13d6>
    35b6:	00003097          	auipc	ra,0x3
    35ba:	9c6080e7          	jalr	-1594(ra) # 5f7c <printf>
      exit(1);
    35be:	4505                	li	a0,1
...
00000000000035e0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35f0:	e7c50513          	addi	a0,a0,-388 # 7468 <malloc+0x142e>
  ...
  if(chdir("dir0") < 0){
    ...
    3604:	e6850513          	addi	a0,a0,-408 # 7468 <malloc+0x142e>
  ...
  if(chdir("..") < 0){
    ...
    3618:	e7450513          	addi	a0,a0,-396 # 7488 <malloc+0x144e>
  ...
  if(unlink("dir0") < 0){
    ...
    362c:	e4050513          	addi	a0,a0,-448 # 7468 <malloc+0x142e>
    ...
    364c:	d8050513          	addi	a0,a0,-640 # 73c8 <malloc+0x138e>
    3650:	00003097          	auipc	ra,0x3
    3654:	92c080e7          	jalr	-1748(ra) # 5f7c <printf>
    exit(1);
    3658:	4505                	li	a0,1
    ...
    3668:	e0c50513          	addi	a0,a0,-500 # 7470 <malloc+0x1436>
    366c:	00003097          	auipc	ra,0x3
    3670:	910080e7          	jalr	-1776(ra) # 5f7c <printf>
    exit(1);
    3674:	4505                	li	a0,1
    ...
    3684:	e1050513          	addi	a0,a0,-496 # 7490 <malloc+0x1456>
    3688:	00003097          	auipc	ra,0x3
    368c:	8f4080e7          	jalr	-1804(ra) # 5f7c <printf>
    exit(1);
    3690:	4505                	li	a0,1
    ...
    36a0:	e0c50513          	addi	a0,a0,-500 # 74a8 <malloc+0x146e>
    36a4:	00003097          	auipc	ra,0x3
    36a8:	8d8080e7          	jalr	-1832(ra) # 5f7c <printf>
    exit(1);
    36ac:	4505                	li	a0,1
...
00000000000036b6 <subdir>:
{
  ...
  unlink("ff");
    ...
    36c8:	f2c50513          	addi	a0,a0,-212 # 75f0 <malloc+0x15b6>
    36cc:	00002097          	auipc	ra,0x2
    36d0:	578080e7          	jalr	1400(ra) # 5c44 <unlink>
  if(mkdir("dd") != 0){
    36d4:	00004517          	auipc	a0,0x4
    36d8:	dec50513          	addi	a0,a0,-532 # 74c0 <malloc+0x1486>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36f0:	df450513          	addi	a0,a0,-524 # 74e0 <malloc+0x14a6>
  ...
  write(fd, "ff", 2);
    ...
    3708:	eec58593          	addi	a1,a1,-276 # 75f0 <malloc+0x15b6>
  ...
  if(unlink("dd") >= 0){
    ...
    3722:	da250513          	addi	a0,a0,-606 # 74c0 <malloc+0x1486>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3736:	e0650513          	addi	a0,a0,-506 # 7538 <malloc+0x14fe>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    374e:	e1650513          	addi	a0,a0,-490 # 7560 <malloc+0x1526>
  ...
  write(fd, "FF", 2);
    ...
    3766:	e2e58593          	addi	a1,a1,-466 # 7590 <malloc+0x1556>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3782:	e1a50513          	addi	a0,a0,-486 # 7598 <malloc+0x155e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37ca:	e2258593          	addi	a1,a1,-478 # 75e8 <malloc+0x15ae>
    37ce:	00004517          	auipc	a0,0x4
    37d2:	d9250513          	addi	a0,a0,-622 # 7560 <malloc+0x1526>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37e6:	d7e50513          	addi	a0,a0,-642 # 7560 <malloc+0x1526>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37fc:	d6850513          	addi	a0,a0,-664 # 7560 <malloc+0x1526>
  ...
  if(chdir("dd") != 0){
    ...
    3810:	cb450513          	addi	a0,a0,-844 # 74c0 <malloc+0x1486>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3824:	e6050513          	addi	a0,a0,-416 # 7680 <malloc+0x1646>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3838:	e7c50513          	addi	a0,a0,-388 # 76b0 <malloc+0x1676>
  ...
  if(chdir("./..") != 0){
    ...
    384c:	e9850513          	addi	a0,a0,-360 # 76e0 <malloc+0x16a6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3862:	d8a50513          	addi	a0,a0,-630 # 75e8 <malloc+0x15ae>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    389c:	cc850513          	addi	a0,a0,-824 # 7560 <malloc+0x1526>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b4:	ec050513          	addi	a0,a0,-320 # 7770 <malloc+0x1736>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38cc:	ed850513          	addi	a0,a0,-296 # 77a0 <malloc+0x1766>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38e4:	be050513          	addi	a0,a0,-1056 # 74c0 <malloc+0x1486>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38fa:	bca50513          	addi	a0,a0,-1078 # 74c0 <malloc+0x1486>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3910:	bb450513          	addi	a0,a0,-1100 # 74c0 <malloc+0x1486>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3924:	f1058593          	addi	a1,a1,-240 # 7830 <malloc+0x17f6>
    3928:	00004517          	auipc	a0,0x4
    392c:	e4850513          	addi	a0,a0,-440 # 7770 <malloc+0x1736>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3940:	ef458593          	addi	a1,a1,-268 # 7830 <malloc+0x17f6>
    3944:	00004517          	auipc	a0,0x4
    3948:	e5c50513          	addi	a0,a0,-420 # 77a0 <malloc+0x1766>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    395c:	c9058593          	addi	a1,a1,-880 # 75e8 <malloc+0x15ae>
    3960:	00004517          	auipc	a0,0x4
    3964:	b8050513          	addi	a0,a0,-1152 # 74e0 <malloc+0x14a6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3978:	dfc50513          	addi	a0,a0,-516 # 7770 <malloc+0x1736>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    398c:	e1850513          	addi	a0,a0,-488 # 77a0 <malloc+0x1766>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39a0:	c4c50513          	addi	a0,a0,-948 # 75e8 <malloc+0x15ae>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39b4:	df050513          	addi	a0,a0,-528 # 77a0 <malloc+0x1766>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39c8:	dac50513          	addi	a0,a0,-596 # 7770 <malloc+0x1736>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39dc:	b0850513          	addi	a0,a0,-1272 # 74e0 <malloc+0x14a6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39f0:	f9450513          	addi	a0,a0,-108 # 7980 <malloc+0x1946>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a04:	be850513          	addi	a0,a0,-1048 # 75e8 <malloc+0x15ae>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a18:	acc50513          	addi	a0,a0,-1332 # 74e0 <malloc+0x14a6>
  ...
  if(unlink("dd") == 0){
    ...
    3a2c:	a9850513          	addi	a0,a0,-1384 # 74c0 <malloc+0x1486>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a40:	fb450513          	addi	a0,a0,-76 # 79f0 <malloc+0x19b6>
  ...
  if(unlink("dd") < 0){
    ...
    3a54:	a7050513          	addi	a0,a0,-1424 # 74c0 <malloc+0x1486>
    ...
    3a76:	a5650513          	addi	a0,a0,-1450 # 74c8 <malloc+0x148e>
    3a7a:	00002097          	auipc	ra,0x2
    3a7e:	502080e7          	jalr	1282(ra) # 5f7c <printf>
    exit(1);
    3a82:	4505                	li	a0,1
    ...
    3a92:	a5a50513          	addi	a0,a0,-1446 # 74e8 <malloc+0x14ae>
    3a96:	00002097          	auipc	ra,0x2
    3a9a:	4e6080e7          	jalr	1254(ra) # 5f7c <printf>
    exit(1);
    3a9e:	4505                	li	a0,1
    ...
    3aae:	a5e50513          	addi	a0,a0,-1442 # 7508 <malloc+0x14ce>
    3ab2:	00002097          	auipc	ra,0x2
    3ab6:	4ca080e7          	jalr	1226(ra) # 5f7c <printf>
    exit(1);
    3aba:	4505                	li	a0,1
    ...
    3aca:	a7a50513          	addi	a0,a0,-1414 # 7540 <malloc+0x1506>
    3ace:	00002097          	auipc	ra,0x2
    3ad2:	4ae080e7          	jalr	1198(ra) # 5f7c <printf>
    exit(1);
    3ad6:	4505                	li	a0,1
    ...
    3ae6:	a8e50513          	addi	a0,a0,-1394 # 7570 <malloc+0x1536>
    3aea:	00002097          	auipc	ra,0x2
    3aee:	492080e7          	jalr	1170(ra) # 5f7c <printf>
    exit(1);
    3af2:	4505                	li	a0,1
    ...
    3b02:	aaa50513          	addi	a0,a0,-1366 # 75a8 <malloc+0x156e>
    3b06:	00002097          	auipc	ra,0x2
    3b0a:	476080e7          	jalr	1142(ra) # 5f7c <printf>
    exit(1);
    3b0e:	4505                	li	a0,1
    ...
    3b1e:	aae50513          	addi	a0,a0,-1362 # 75c8 <malloc+0x158e>
    3b22:	00002097          	auipc	ra,0x2
    3b26:	45a080e7          	jalr	1114(ra) # 5f7c <printf>
    exit(1);
    3b2a:	4505                	li	a0,1
    ...
    3b3a:	ac250513          	addi	a0,a0,-1342 # 75f8 <malloc+0x15be>
    3b3e:	00002097          	auipc	ra,0x2
    3b42:	43e080e7          	jalr	1086(ra) # 5f7c <printf>
    exit(1);
    3b46:	4505                	li	a0,1
    ...
    3b56:	ace50513          	addi	a0,a0,-1330 # 7620 <malloc+0x15e6>
    3b5a:	00002097          	auipc	ra,0x2
    3b5e:	422080e7          	jalr	1058(ra) # 5f7c <printf>
    exit(1);
    3b62:	4505                	li	a0,1
    ...
    3b72:	ad250513          	addi	a0,a0,-1326 # 7640 <malloc+0x1606>
    3b76:	00002097          	auipc	ra,0x2
    3b7a:	406080e7          	jalr	1030(ra) # 5f7c <printf>
    exit(1);
    3b7e:	4505                	li	a0,1
    ...
    3b8e:	ade50513          	addi	a0,a0,-1314 # 7668 <malloc+0x162e>
    3b92:	00002097          	auipc	ra,0x2
    3b96:	3ea080e7          	jalr	1002(ra) # 5f7c <printf>
    exit(1);
    3b9a:	4505                	li	a0,1
    ...
    3baa:	aea50513          	addi	a0,a0,-1302 # 7690 <malloc+0x1656>
    3bae:	00002097          	auipc	ra,0x2
    3bb2:	3ce080e7          	jalr	974(ra) # 5f7c <printf>
    exit(1);
    3bb6:	4505                	li	a0,1
    ...
    3bc6:	afe50513          	addi	a0,a0,-1282 # 76c0 <malloc+0x1686>
    3bca:	00002097          	auipc	ra,0x2
    3bce:	3b2080e7          	jalr	946(ra) # 5f7c <printf>
    exit(1);
    3bd2:	4505                	li	a0,1
    ...
    3be2:	b0a50513          	addi	a0,a0,-1270 # 76e8 <malloc+0x16ae>
    3be6:	00002097          	auipc	ra,0x2
    3bea:	396080e7          	jalr	918(ra) # 5f7c <printf>
    exit(1);
    3bee:	4505                	li	a0,1
    ...
    3bfe:	b0650513          	addi	a0,a0,-1274 # 7700 <malloc+0x16c6>
    3c02:	00002097          	auipc	ra,0x2
    3c06:	37a080e7          	jalr	890(ra) # 5f7c <printf>
    exit(1);
    3c0a:	4505                	li	a0,1
    ...
    3c1a:	b0a50513          	addi	a0,a0,-1270 # 7720 <malloc+0x16e6>
    3c1e:	00002097          	auipc	ra,0x2
    3c22:	35e080e7          	jalr	862(ra) # 5f7c <printf>
    exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c36:	b0e50513          	addi	a0,a0,-1266 # 7740 <malloc+0x1706>
    3c3a:	00002097          	auipc	ra,0x2
    3c3e:	342080e7          	jalr	834(ra) # 5f7c <printf>
    exit(1);
    3c42:	4505                	li	a0,1
    ...
    3c52:	b3250513          	addi	a0,a0,-1230 # 7780 <malloc+0x1746>
    3c56:	00002097          	auipc	ra,0x2
    3c5a:	326080e7          	jalr	806(ra) # 5f7c <printf>
    exit(1);
    3c5e:	4505                	li	a0,1
    ...
    3c6e:	b4650513          	addi	a0,a0,-1210 # 77b0 <malloc+0x1776>
    3c72:	00002097          	auipc	ra,0x2
    3c76:	30a080e7          	jalr	778(ra) # 5f7c <printf>
    exit(1);
    3c7a:	4505                	li	a0,1
    ...
    3c8a:	b4a50513          	addi	a0,a0,-1206 # 77d0 <malloc+0x1796>
    3c8e:	00002097          	auipc	ra,0x2
    3c92:	2ee080e7          	jalr	750(ra) # 5f7c <printf>
    exit(1);
    3c96:	4505                	li	a0,1
    ...
    3ca6:	b4e50513          	addi	a0,a0,-1202 # 77f0 <malloc+0x17b6>
    3caa:	00002097          	auipc	ra,0x2
    3cae:	2d2080e7          	jalr	722(ra) # 5f7c <printf>
    exit(1);
    3cb2:	4505                	li	a0,1
    ...
    3cc2:	b5250513          	addi	a0,a0,-1198 # 7810 <malloc+0x17d6>
    3cc6:	00002097          	auipc	ra,0x2
    3cca:	2b6080e7          	jalr	694(ra) # 5f7c <printf>
    exit(1);
    3cce:	4505                	li	a0,1
    ...
    3cde:	b6650513          	addi	a0,a0,-1178 # 7840 <malloc+0x1806>
    3ce2:	00002097          	auipc	ra,0x2
    3ce6:	29a080e7          	jalr	666(ra) # 5f7c <printf>
    exit(1);
    3cea:	4505                	li	a0,1
    ...
    3cfa:	b7250513          	addi	a0,a0,-1166 # 7868 <malloc+0x182e>
    3cfe:	00002097          	auipc	ra,0x2
    3d02:	27e080e7          	jalr	638(ra) # 5f7c <printf>
    exit(1);
    3d06:	4505                	li	a0,1
    ...
    3d16:	b7e50513          	addi	a0,a0,-1154 # 7890 <malloc+0x1856>
    3d1a:	00002097          	auipc	ra,0x2
    3d1e:	262080e7          	jalr	610(ra) # 5f7c <printf>
    exit(1);
    3d22:	4505                	li	a0,1
    ...
    3d32:	b8a50513          	addi	a0,a0,-1142 # 78b8 <malloc+0x187e>
    3d36:	00002097          	auipc	ra,0x2
    3d3a:	246080e7          	jalr	582(ra) # 5f7c <printf>
    exit(1);
    3d3e:	4505                	li	a0,1
    ...
    3d4e:	b8e50513          	addi	a0,a0,-1138 # 78d8 <malloc+0x189e>
    3d52:	00002097          	auipc	ra,0x2
    3d56:	22a080e7          	jalr	554(ra) # 5f7c <printf>
    exit(1);
    3d5a:	4505                	li	a0,1
    ...
    3d6a:	b9250513          	addi	a0,a0,-1134 # 78f8 <malloc+0x18be>
    3d6e:	00002097          	auipc	ra,0x2
    3d72:	20e080e7          	jalr	526(ra) # 5f7c <printf>
    exit(1);
    3d76:	4505                	li	a0,1
    ...
    3d86:	b9e50513          	addi	a0,a0,-1122 # 7920 <malloc+0x18e6>
    3d8a:	00002097          	auipc	ra,0x2
    3d8e:	1f2080e7          	jalr	498(ra) # 5f7c <printf>
    exit(1);
    3d92:	4505                	li	a0,1
    ...
    3da2:	ba250513          	addi	a0,a0,-1118 # 7940 <malloc+0x1906>
    3da6:	00002097          	auipc	ra,0x2
    3daa:	1d6080e7          	jalr	470(ra) # 5f7c <printf>
    exit(1);
    3dae:	4505                	li	a0,1
    ...
    3dbe:	ba650513          	addi	a0,a0,-1114 # 7960 <malloc+0x1926>
    3dc2:	00002097          	auipc	ra,0x2
    3dc6:	1ba080e7          	jalr	442(ra) # 5f7c <printf>
    exit(1);
    3dca:	4505                	li	a0,1
    ...
    3dda:	bb250513          	addi	a0,a0,-1102 # 7988 <malloc+0x194e>
    3dde:	00002097          	auipc	ra,0x2
    3de2:	19e080e7          	jalr	414(ra) # 5f7c <printf>
    exit(1);
    3de6:	4505                	li	a0,1
    ...
    3df6:	82e50513          	addi	a0,a0,-2002 # 7620 <malloc+0x15e6>
    3dfa:	00002097          	auipc	ra,0x2
    3dfe:	182080e7          	jalr	386(ra) # 5f7c <printf>
    exit(1);
    3e02:	4505                	li	a0,1
    ...
    3e12:	b9a50513          	addi	a0,a0,-1126 # 79a8 <malloc+0x196e>
    3e16:	00002097          	auipc	ra,0x2
    3e1a:	166080e7          	jalr	358(ra) # 5f7c <printf>
    exit(1);
    3e1e:	4505                	li	a0,1
    ...
    3e2e:	b9e50513          	addi	a0,a0,-1122 # 79c8 <malloc+0x198e>
    3e32:	00002097          	auipc	ra,0x2
    3e36:	14a080e7          	jalr	330(ra) # 5f7c <printf>
    exit(1);
    3e3a:	4505                	li	a0,1
    ...
    3e4a:	bb250513          	addi	a0,a0,-1102 # 79f8 <malloc+0x19be>
    3e4e:	00002097          	auipc	ra,0x2
    3e52:	12e080e7          	jalr	302(ra) # 5f7c <printf>
    exit(1);
    3e56:	4505                	li	a0,1
    ...
    3e66:	bb650513          	addi	a0,a0,-1098 # 7a18 <malloc+0x19de>
    3e6a:	00002097          	auipc	ra,0x2
    3e6e:	112080e7          	jalr	274(ra) # 5f7c <printf>
    exit(1);
    3e72:	4505                	li	a0,1
...
0000000000003e7c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e8c:	ba850513          	addi	a0,a0,-1112 # 7a30 <malloc+0x19f6>
  ...
  if(chdir("dots") != 0){
    ...
    3e9e:	b9650513          	addi	a0,a0,-1130 # 7a30 <malloc+0x19f6>
  ...
  if(unlink(".") == 0){
    ...
    3eb0:	9b450513          	addi	a0,a0,-1612 # 6860 <malloc+0x826>
  ...
  if(unlink("..") == 0){
    ...
    3ec2:	5ca50513          	addi	a0,a0,1482 # 7488 <malloc+0x144e>
  ...
  if(chdir("/") != 0){
    ...
    3ed4:	56050513          	addi	a0,a0,1376 # 7430 <malloc+0x13f6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ee6:	bb650513          	addi	a0,a0,-1098 # 7a98 <malloc+0x1a5e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ef8:	bcc50513          	addi	a0,a0,-1076 # 7ac0 <malloc+0x1a86>
  ...
  if(unlink("dots") != 0){
    ...
    3f0a:	b2a50513          	addi	a0,a0,-1238 # 7a30 <malloc+0x19f6>
    ...
    3f28:	b1450513          	addi	a0,a0,-1260 # 7a38 <malloc+0x19fe>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	050080e7          	jalr	80(ra) # 5f7c <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	b1050513          	addi	a0,a0,-1264 # 7a50 <malloc+0x1a16>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	034080e7          	jalr	52(ra) # 5f7c <printf>
    exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	b0c50513          	addi	a0,a0,-1268 # 7a68 <malloc+0x1a2e>
    3f64:	00002097          	auipc	ra,0x2
    3f68:	018080e7          	jalr	24(ra) # 5f7c <printf>
    exit(1);
    3f6c:	4505                	li	a0,1
    ...
    3f7c:	b0850513          	addi	a0,a0,-1272 # 7a80 <malloc+0x1a46>
    3f80:	00002097          	auipc	ra,0x2
    3f84:	ffc080e7          	jalr	-4(ra) # 5f7c <printf>
    exit(1);
    3f88:	4505                	li	a0,1
    ...
    3f98:	4a450513          	addi	a0,a0,1188 # 7438 <malloc+0x13fe>
    3f9c:	00002097          	auipc	ra,0x2
    3fa0:	fe0080e7          	jalr	-32(ra) # 5f7c <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb4:	af050513          	addi	a0,a0,-1296 # 7aa0 <malloc+0x1a66>
    3fb8:	00002097          	auipc	ra,0x2
    3fbc:	fc4080e7          	jalr	-60(ra) # 5f7c <printf>
    exit(1);
    3fc0:	4505                	li	a0,1
    ...
    3fd0:	afc50513          	addi	a0,a0,-1284 # 7ac8 <malloc+0x1a8e>
    3fd4:	00002097          	auipc	ra,0x2
    3fd8:	fa8080e7          	jalr	-88(ra) # 5f7c <printf>
    exit(1);
    3fdc:	4505                	li	a0,1
    ...
    3fec:	b0050513          	addi	a0,a0,-1280 # 7ae8 <malloc+0x1aae>
    3ff0:	00002097          	auipc	ra,0x2
    3ff4:	f8c080e7          	jalr	-116(ra) # 5f7c <printf>
    exit(1);
    3ff8:	4505                	li	a0,1
...
0000000000004002 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4018:	af450513          	addi	a0,a0,-1292 # 7b08 <malloc+0x1ace>
  ...
  if(chdir("dirfile") == 0){
    ...
    4034:	ad850513          	addi	a0,a0,-1320 # 7b08 <malloc+0x1ace>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4048:	b0c50513          	addi	a0,a0,-1268 # 7b50 <malloc+0x1b16>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4060:	af450513          	addi	a0,a0,-1292 # 7b50 <malloc+0x1b16>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4074:	ae050513          	addi	a0,a0,-1312 # 7b50 <malloc+0x1b16>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4088:	acc50513          	addi	a0,a0,-1332 # 7b50 <malloc+0x1b16>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    409c:	ab858593          	addi	a1,a1,-1352 # 7b50 <malloc+0x1b16>
    40a0:	00002517          	auipc	a0,0x2
    40a4:	2b050513          	addi	a0,a0,688 # 6350 <malloc+0x316>
  ...
  if(unlink("dirfile") != 0){
    ...
    40b8:	a5450513          	addi	a0,a0,-1452 # 7b08 <malloc+0x1ace>
  ...
  fd = open(".", O_RDWR);
    ...
    40ce:	79650513          	addi	a0,a0,1942 # 6860 <malloc+0x826>
  ...
  fd = open(".", 0);
    ...
    40e4:	78050513          	addi	a0,a0,1920 # 6860 <malloc+0x826>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40f8:	0f458593          	addi	a1,a1,244 # 61e8 <malloc+0x1ae>
  ...
  close(fd);
    ...
    4124:	9f050513          	addi	a0,a0,-1552 # 7b10 <malloc+0x1ad6>
    4128:	00002097          	auipc	ra,0x2
    412c:	e54080e7          	jalr	-428(ra) # 5f7c <printf>
    exit(1);
    4130:	4505                	li	a0,1
    ...
    4140:	9f450513          	addi	a0,a0,-1548 # 7b30 <malloc+0x1af6>
    4144:	00002097          	auipc	ra,0x2
    4148:	e38080e7          	jalr	-456(ra) # 5f7c <printf>
    exit(1);
    414c:	4505                	li	a0,1
    ...
    415c:	a0850513          	addi	a0,a0,-1528 # 7b60 <malloc+0x1b26>
    4160:	00002097          	auipc	ra,0x2
    4164:	e1c080e7          	jalr	-484(ra) # 5f7c <printf>
    exit(1);
    4168:	4505                	li	a0,1
    ...
    4178:	9ec50513          	addi	a0,a0,-1556 # 7b60 <malloc+0x1b26>
    417c:	00002097          	auipc	ra,0x2
    4180:	e00080e7          	jalr	-512(ra) # 5f7c <printf>
    exit(1);
    4184:	4505                	li	a0,1
    ...
    4194:	9f850513          	addi	a0,a0,-1544 # 7b88 <malloc+0x1b4e>
    4198:	00002097          	auipc	ra,0x2
    419c:	de4080e7          	jalr	-540(ra) # 5f7c <printf>
    exit(1);
    41a0:	4505                	li	a0,1
    ...
    41b0:	a0450513          	addi	a0,a0,-1532 # 7bb0 <malloc+0x1b76>
    41b4:	00002097          	auipc	ra,0x2
    41b8:	dc8080e7          	jalr	-568(ra) # 5f7c <printf>
    exit(1);
    41bc:	4505                	li	a0,1
    ...
    41cc:	a1050513          	addi	a0,a0,-1520 # 7bd8 <malloc+0x1b9e>
    41d0:	00002097          	auipc	ra,0x2
    41d4:	dac080e7          	jalr	-596(ra) # 5f7c <printf>
    exit(1);
    41d8:	4505                	li	a0,1
    ...
    41e8:	a1c50513          	addi	a0,a0,-1508 # 7c00 <malloc+0x1bc6>
    41ec:	00002097          	auipc	ra,0x2
    41f0:	d90080e7          	jalr	-624(ra) # 5f7c <printf>
    exit(1);
    41f4:	4505                	li	a0,1
    ...
    4204:	a2050513          	addi	a0,a0,-1504 # 7c20 <malloc+0x1be6>
    4208:	00002097          	auipc	ra,0x2
    420c:	d74080e7          	jalr	-652(ra) # 5f7c <printf>
    exit(1);
    4210:	4505                	li	a0,1
    ...
    4220:	a2c50513          	addi	a0,a0,-1492 # 7c48 <malloc+0x1c0e>
    4224:	00002097          	auipc	ra,0x2
    4228:	d58080e7          	jalr	-680(ra) # 5f7c <printf>
    exit(1);
    422c:	4505                	li	a0,1
...
0000000000004236 <iref>:
{
    ...
    4254:	a10a0a13          	addi	s4,s4,-1520 # 7c60 <malloc+0x1c26>
    mkdir("");
    4258:	00003497          	auipc	s1,0x3
    425c:	51048493          	addi	s1,s1,1296 # 7768 <malloc+0x172e>
    link("README", "");
    4260:	00002a97          	auipc	s5,0x2
    4264:	0f0a8a93          	addi	s5,s5,240 # 6350 <malloc+0x316>
    fd = open("xx", O_CREATE);
    4268:	00004997          	auipc	s3,0x4
    426c:	8f098993          	addi	s3,s3,-1808 # 7b58 <malloc+0x1b1e>
    4270:	a891                	j	42c4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4272:	85da                	mv	a1,s6
    4274:	00004517          	auipc	a0,0x4
    4278:	9f450513          	addi	a0,a0,-1548 # 7c68 <malloc+0x1c2e>
    427c:	00002097          	auipc	ra,0x2
    4280:	d00080e7          	jalr	-768(ra) # 5f7c <printf>
      exit(1);
    4284:	4505                	li	a0,1
    ...
    4294:	9f050513          	addi	a0,a0,-1552 # 7c80 <malloc+0x1c46>
    4298:	00002097          	auipc	ra,0x2
    429c:	ce4080e7          	jalr	-796(ra) # 5f7c <printf>
      exit(1);
    42a0:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4328:	16498993          	addi	s3,s3,356 # 7488 <malloc+0x144e>
    unlink("irefd");
    432c:	00004917          	auipc	s2,0x4
    4330:	93490913          	addi	s2,s2,-1740 # 7c60 <malloc+0x1c26>
    chdir("..");
    4334:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4350:	0e450513          	addi	a0,a0,228 # 7430 <malloc+0x13f6>
...
0000000000004370 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4380:	91c50513          	addi	a0,a0,-1764 # 7c98 <malloc+0x1c5e>
  ...
  if(pid == 0){
    ...
    43a4:	8f850513          	addi	a0,a0,-1800 # 7c98 <malloc+0x1c5e>
    ...
    43ba:	90250513          	addi	a0,a0,-1790 # 7cb8 <malloc+0x1c7e>
    43be:	00002097          	auipc	ra,0x2
    43c2:	bbe080e7          	jalr	-1090(ra) # 5f7c <printf>
      exit(1);
    43c6:	4505                	li	a0,1
    ...
    43d6:	8ce50513          	addi	a0,a0,-1842 # 7ca0 <malloc+0x1c66>
    43da:	00002097          	auipc	ra,0x2
    43de:	ba2080e7          	jalr	-1118(ra) # 5f7c <printf>
    exit(1);
    43e2:	4505                	li	a0,1
    ...
    43f2:	61250513          	addi	a0,a0,1554 # 6a00 <malloc+0x9c6>
    43f6:	00002097          	auipc	ra,0x2
    43fa:	b86080e7          	jalr	-1146(ra) # 5f7c <printf>
    exit(1);
    43fe:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4420:	87c50513          	addi	a0,a0,-1924 # 7c98 <malloc+0x1c5e>
    ...
    4434:	7c050513          	addi	a0,a0,1984 # 6bf0 <malloc+0xbb6>
    4438:	00002097          	auipc	ra,0x2
    443c:	b44080e7          	jalr	-1212(ra) # 5f7c <printf>
    exit(1);
    4440:	4505                	li	a0,1
...
0000000000004462 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4472:	87250513          	addi	a0,a0,-1934 # 7ce0 <malloc+0x1ca6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    449e:	84650513          	addi	a0,a0,-1978 # 7ce0 <malloc+0x1ca6>
  ...
  sleep(10); // one second
    ...
    44d6:	6ee50513          	addi	a0,a0,1774 # 6bc0 <malloc+0xb86>
    44da:	00002097          	auipc	ra,0x2
    44de:	aa2080e7          	jalr	-1374(ra) # 5f7c <printf>
    exit(1);
    44e2:	4505                	li	a0,1
    ...
    44f0:	7f448493          	addi	s1,s1,2036 # 7ce0 <malloc+0x1ca6>
    44f4:	4581                	li	a1,0
    44f6:	8526                	mv	a0,s1
...
0000000000004532 <killstatus>:
{
  ...
  exit(0);
    ...
    4598:	46c50513          	addi	a0,a0,1132 # 6a00 <malloc+0x9c6>
    459c:	00002097          	auipc	ra,0x2
    45a0:	9e0080e7          	jalr	-1568(ra) # 5f7c <printf>
      exit(1);
    45a4:	4505                	li	a0,1
    ...
    45be:	73650513          	addi	a0,a0,1846 # 7cf0 <malloc+0x1cb6>
    45c2:	00002097          	auipc	ra,0x2
    45c6:	9ba080e7          	jalr	-1606(ra) # 5f7c <printf>
       exit(1);
    45ca:	4505                	li	a0,1
...
00000000000045d4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45fe:	5c650513          	addi	a0,a0,1478 # 6bc0 <malloc+0xb86>
    4602:	00002097          	auipc	ra,0x2
    4606:	97a080e7          	jalr	-1670(ra) # 5f7c <printf>
    exit(1);
    460a:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    462c:	3d850513          	addi	a0,a0,984 # 6a00 <malloc+0x9c6>
    4630:	00002097          	auipc	ra,0x2
    4634:	94c080e7          	jalr	-1716(ra) # 5f7c <printf>
    exit(1);
    4638:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4670:	b7c58593          	addi	a1,a1,-1156 # 61e8 <malloc+0x1ae>
    ...
    469a:	36a50513          	addi	a0,a0,874 # 6a00 <malloc+0x9c6>
    469e:	00002097          	auipc	ra,0x2
    46a2:	8de080e7          	jalr	-1826(ra) # 5f7c <printf>
     exit(1);
    46a6:	4505                	li	a0,1
    ...
    46b6:	65e50513          	addi	a0,a0,1630 # 7d10 <malloc+0x1cd6>
    46ba:	00002097          	auipc	ra,0x2
    46be:	8c2080e7          	jalr	-1854(ra) # 5f7c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46f2:	63a50513          	addi	a0,a0,1594 # 7d28 <malloc+0x1cee>
    46f6:	00002097          	auipc	ra,0x2
    46fa:	886080e7          	jalr	-1914(ra) # 5f7c <printf>
}
  ...
  printf("kill... ");
    ...
    471e:	62650513          	addi	a0,a0,1574 # 7d40 <malloc+0x1d06>
    4722:	00002097          	auipc	ra,0x2
    4726:	85a080e7          	jalr	-1958(ra) # 5f7c <printf>
  kill(pid1);
    472a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    474c:	60850513          	addi	a0,a0,1544 # 7d50 <malloc+0x1d16>
    4750:	00002097          	auipc	ra,0x2
    4754:	82c080e7          	jalr	-2004(ra) # 5f7c <printf>
  wait(0);
    4758:	4501                	li	a0,0
...
0000000000004778 <reparent>:
{
  ...
  exit(0);
    ...
    47cc:	23850513          	addi	a0,a0,568 # 6a00 <malloc+0x9c6>
    47d0:	00001097          	auipc	ra,0x1
    47d4:	7ac080e7          	jalr	1964(ra) # 5f7c <printf>
      exit(1);
    47d8:	4505                	li	a0,1
    ...
    47e8:	3a450513          	addi	a0,a0,932 # 6b88 <malloc+0xb4e>
    47ec:	00001097          	auipc	ra,0x1
    47f0:	790080e7          	jalr	1936(ra) # 5f7c <printf>
        exit(1);
    47f4:	4505                	li	a0,1
...
0000000000004828 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    485e:	2ae50513          	addi	a0,a0,686 # 6b08 <malloc+0xace>
    4862:	00001097          	auipc	ra,0x1
    4866:	71a080e7          	jalr	1818(ra) # 5f7c <printf>
    exit(1);
    486a:	4505                	li	a0,1
    ...
    4892:	95a58593          	addi	a1,a1,-1702 # 61e8 <malloc+0x1ae>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4956:	40e50513          	addi	a0,a0,1038 # 7d60 <malloc+0x1d26>
    495a:	00001097          	auipc	ra,0x1
    495e:	622080e7          	jalr	1570(ra) # 5f7c <printf>
    exit(1);
    4962:	4505                	li	a0,1
    ...
    4972:	09250513          	addi	a0,a0,146 # 6a00 <malloc+0x9c6>
    4976:	00001097          	auipc	ra,0x1
    497a:	606080e7          	jalr	1542(ra) # 5f7c <printf>
    exit(1);
    497e:	4505                	li	a0,1
    ...
    49be:	3c650513          	addi	a0,a0,966 # 7d80 <malloc+0x1d46>
    49c2:	00001097          	auipc	ra,0x1
    49c6:	5ba080e7          	jalr	1466(ra) # 5f7c <printf>
    exit(1);
    49ca:	4505                	li	a0,1
...
00000000000049de <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a28:	616080e7          	jalr	1558(ra) # 603a <malloc>
    ...
    4a62:	35250513          	addi	a0,a0,850 # 7db0 <malloc+0x1d76>
    4a66:	00001097          	auipc	ra,0x1
    4a6a:	516080e7          	jalr	1302(ra) # 5f7c <printf>
      exit(1);
    4a6e:	4505                	li	a0,1
...
0000000000004a82 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b18:	2cc50513          	addi	a0,a0,716 # 7de0 <malloc+0x1da6>
    4b1c:	00001097          	auipc	ra,0x1
    4b20:	460080e7          	jalr	1120(ra) # 5f7c <printf>
    exit(1);
    4b24:	4505                	li	a0,1
    ...
    4b34:	2d850513          	addi	a0,a0,728 # 7e08 <malloc+0x1dce>
    4b38:	00001097          	auipc	ra,0x1
    4b3c:	444080e7          	jalr	1092(ra) # 5f7c <printf>
      exit(1);
    4b40:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b78:	25c50513          	addi	a0,a0,604 # 7dd0 <malloc+0x1d96>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bb8:	27450513          	addi	a0,a0,628 # 7e28 <malloc+0x1dee>
    4bbc:	00001097          	auipc	ra,0x1
    4bc0:	3c0080e7          	jalr	960(ra) # 5f7c <printf>
    exit(1);
    4bc4:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bf4:	1e050513          	addi	a0,a0,480 # 7dd0 <malloc+0x1d96>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c1a:	23a50513          	addi	a0,a0,570 # 7e50 <malloc+0x1e16>
    4c1e:	00001097          	auipc	ra,0x1
    4c22:	35e080e7          	jalr	862(ra) # 5f7c <printf>
    exit(1);
    4c26:	4505                	li	a0,1
...
0000000000004c3a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c60:	4c478793          	addi	a5,a5,1220 # 6120 <malloc+0xe6>
    4c64:	f6f43823          	sd	a5,-144(s0)
    4c68:	00001797          	auipc	a5,0x1
    4c6c:	4c078793          	addi	a5,a5,1216 # 6128 <malloc+0xee>
    4c70:	f6f43c23          	sd	a5,-136(s0)
    4c74:	00001797          	auipc	a5,0x1
    4c78:	4bc78793          	addi	a5,a5,1212 # 6130 <malloc+0xf6>
    4c7c:	f8f43023          	sd	a5,-128(s0)
    4c80:	00001797          	auipc	a5,0x1
    4c84:	4b878793          	addi	a5,a5,1208 # 6138 <malloc+0xfe>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cfc:	11050513          	addi	a0,a0,272 # 6e08 <malloc+0xdce>
    4d00:	00001097          	auipc	ra,0x1
    4d04:	27c080e7          	jalr	636(ra) # 5f7c <printf>
      exit(1);
    4d08:	4505                	li	a0,1
    ...
    4d78:	0f450513          	addi	a0,a0,244 # 7e68 <malloc+0x1e2e>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	200080e7          	jalr	512(ra) # 5f7c <printf>
        exit(1);
    4d84:	4505                	li	a0,1
    ...
    4d92:	0ea50513          	addi	a0,a0,234 # 7e78 <malloc+0x1e3e>
    4d96:	00001097          	auipc	ra,0x1
    4d9a:	1e6080e7          	jalr	486(ra) # 5f7c <printf>
          exit(1);
    4d9e:	4505                	li	a0,1
    ...
    4dba:	0da50513          	addi	a0,a0,218 # 7e90 <malloc+0x1e56>
    4dbe:	00001097          	auipc	ra,0x1
    4dc2:	1be080e7          	jalr	446(ra) # 5f7c <printf>
          exit(1);
    4dc6:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e48:	05c50513          	addi	a0,a0,92 # 7ea0 <malloc+0x1e66>
    4e4c:	00001097          	auipc	ra,0x1
    4e50:	130080e7          	jalr	304(ra) # 5f7c <printf>
      exit(1);
    4e54:	4505                	li	a0,1
...
0000000000004e7c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eaa:	012b8b93          	addi	s7,s7,18 # 7eb8 <malloc+0x1e7e>
  for(i = 0; i < N; i++){
    ...
    4eec:	fd850513          	addi	a0,a0,-40 # 7ec0 <malloc+0x1e86>
    4ef0:	00001097          	auipc	ra,0x1
    4ef4:	08c080e7          	jalr	140(ra) # 5f7c <printf>
        exit(1);
    4ef8:	4505                	li	a0,1
    ...
    4f0a:	fb250513          	addi	a0,a0,-78 # 7eb8 <malloc+0x1e7e>
  ...
  fd = open(".", 0);
    ...
    4f42:	92250513          	addi	a0,a0,-1758 # 6860 <malloc+0x826>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fb8:	f2c50513          	addi	a0,a0,-212 # 7ee0 <malloc+0x1ea6>
    4fbc:	00001097          	auipc	ra,0x1
    4fc0:	fc0080e7          	jalr	-64(ra) # 5f7c <printf>
        exit(1);
    4fc4:	4505                	li	a0,1
    ...
    4fd8:	f2c50513          	addi	a0,a0,-212 # 7f00 <malloc+0x1ec6>
    4fdc:	00001097          	auipc	ra,0x1
    4fe0:	fa0080e7          	jalr	-96(ra) # 5f7c <printf>
        exit(1);
    4fe4:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    5010:	f1c50513          	addi	a0,a0,-228 # 7f28 <malloc+0x1eee>
    5014:	00001097          	auipc	ra,0x1
    5018:	f68080e7          	jalr	-152(ra) # 5f7c <printf>
    exit(1);
    501c:	4505                	li	a0,1
    ...
    502c:	9d850513          	addi	a0,a0,-1576 # 6a00 <malloc+0x9c6>
    5030:	00001097          	auipc	ra,0x1
    5034:	f4c080e7          	jalr	-180(ra) # 5f7c <printf>
      exit(1);
    5038:	4505                	li	a0,1
...
00000000000051d6 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    525e:	d0650513          	addi	a0,a0,-762 # 7f60 <malloc+0x1f26>
  ...
  for(i = 0; ; i++){
    ...
    52c2:	cb250513          	addi	a0,a0,-846 # 7f70 <malloc+0x1f36>
    52c6:	00001097          	auipc	ra,0x1
    52ca:	cb6080e7          	jalr	-842(ra) # 5f7c <printf>
    exit(1);
    52ce:	4505                	li	a0,1
    ...
    52de:	cb650513          	addi	a0,a0,-842 # 7f90 <malloc+0x1f56>
    52e2:	00001097          	auipc	ra,0x1
    52e6:	c9a080e7          	jalr	-870(ra) # 5f7c <printf>
      exit(1);
    52ea:	4505                	li	a0,1
    ...
    52fa:	cba50513          	addi	a0,a0,-838 # 7fb0 <malloc+0x1f76>
    52fe:	00001097          	auipc	ra,0x1
    5302:	c7e080e7          	jalr	-898(ra) # 5f7c <printf>
    exit(1);
    5306:	4505                	li	a0,1
    ...
    5316:	cbe50513          	addi	a0,a0,-834 # 7fd0 <malloc+0x1f96>
    531a:	00001097          	auipc	ra,0x1
    531e:	c62080e7          	jalr	-926(ra) # 5f7c <printf>
      exit(1);
    5322:	4505                	li	a0,1
    ...
    5332:	cc250513          	addi	a0,a0,-830 # 7ff0 <malloc+0x1fb6>
    5336:	00001097          	auipc	ra,0x1
    533a:	c46080e7          	jalr	-954(ra) # 5f7c <printf>
      exit(1);
    533e:	4505                	li	a0,1
    ...
    534e:	cbe50513          	addi	a0,a0,-834 # 8008 <malloc+0x1fce>
    5352:	00001097          	auipc	ra,0x1
    5356:	c2a080e7          	jalr	-982(ra) # 5f7c <printf>
      exit(1);
    535a:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    537c:	be850513          	addi	a0,a0,-1048 # 7f60 <malloc+0x1f26>
    ...
    53a0:	c8c50513          	addi	a0,a0,-884 # 8028 <malloc+0x1fee>
    53a4:	00001097          	auipc	ra,0x1
    53a8:	bd8080e7          	jalr	-1064(ra) # 5f7c <printf>
    exit(1);
    53ac:	4505                	li	a0,1
...
00000000000053b6 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53d8:	c7450513          	addi	a0,a0,-908 # 8048 <malloc+0x200e>
    53dc:	00001097          	auipc	ra,0x1
    53e0:	ba0080e7          	jalr	-1120(ra) # 5f7c <printf>
  for(nfiles = 0; ; nfiles++){
    53e4:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53f8:	c64c8c93          	addi	s9,s9,-924 # 8058 <malloc+0x201e>
    int total = 0;
    53fc:	4d81                	li	s11,0
    ...
    5450:	b30080e7          	jalr	-1232(ra) # 5f7c <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5472:	bfa50513          	addi	a0,a0,-1030 # 8068 <malloc+0x202e>
    5476:	00001097          	auipc	ra,0x1
    547a:	b06080e7          	jalr	-1274(ra) # 5f7c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54e8:	ba450513          	addi	a0,a0,-1116 # 8088 <malloc+0x204e>
    54ec:	00001097          	auipc	ra,0x1
    54f0:	a90080e7          	jalr	-1392(ra) # 5f7c <printf>
}
    ...
    5538:	b4450513          	addi	a0,a0,-1212 # 8078 <malloc+0x203e>
    553c:	00001097          	auipc	ra,0x1
    5540:	a40080e7          	jalr	-1472(ra) # 5f7c <printf>
    close(fd);
    5544:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    556a:	b3a50513          	addi	a0,a0,-1222 # 80a0 <malloc+0x2066>
    556e:	00001097          	auipc	ra,0x1
    5572:	a0e080e7          	jalr	-1522(ra) # 5f7c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    559a:	b3250513          	addi	a0,a0,-1230 # 80c8 <malloc+0x208e>
    559e:	00001097          	auipc	ra,0x1
    55a2:	9de080e7          	jalr	-1570(ra) # 5f7c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55be:	af650513          	addi	a0,a0,-1290 # 80b0 <malloc+0x2076>
    55c2:	00001097          	auipc	ra,0x1
    55c6:	9ba080e7          	jalr	-1606(ra) # 5f7c <printf>
    exit(1);
    55ca:	4505                	li	a0,1
    ...
    55e6:	aee50513          	addi	a0,a0,-1298 # 80d0 <malloc+0x2096>
    55ea:	00001097          	auipc	ra,0x1
    55ee:	992080e7          	jalr	-1646(ra) # 5f7c <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    563e:	a9e50513          	addi	a0,a0,-1378 # 80d8 <malloc+0x209e>
    5642:	00001097          	auipc	ra,0x1
    5646:	93a080e7          	jalr	-1734(ra) # 5f7c <printf>
          return 1;
    564a:	4505                	li	a0,1
        }
      }
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56a0:	b4c98993          	addi	s3,s3,-1204 # 61e8 <malloc+0x1ae>
      uint64 a = (uint64) sbrk(4096);
    ...
    56d2:	a6250513          	addi	a0,a0,-1438 # 8130 <malloc+0x20f6>
    56d6:	00001097          	auipc	ra,0x1
    56da:	8a6080e7          	jalr	-1882(ra) # 5f7c <printf>
        exit(1);
    56de:	4505                	li	a0,1
    ...
    56ec:	a0850513          	addi	a0,a0,-1528 # 80f0 <malloc+0x20b6>
    56f0:	00001097          	auipc	ra,0x1
    56f4:	88c080e7          	jalr	-1908(ra) # 5f7c <printf>
    exit(1);
    56f8:	4505                	li	a0,1
    ...
    5706:	a0e50513          	addi	a0,a0,-1522 # 8110 <malloc+0x20d6>
    570a:	00001097          	auipc	ra,0x1
    570e:	872080e7          	jalr	-1934(ra) # 5f7c <printf>
    exit(1);
    5712:	4505                	li	a0,1
  ...
  while(1){
    ...
    5754:	a0050513          	addi	a0,a0,-1536 # 8150 <malloc+0x2116>
    5758:	00001097          	auipc	ra,0x1
    575c:	824080e7          	jalr	-2012(ra) # 5f7c <printf>
      exit(1);
    5760:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57b6:	9beb8b93          	addi	s7,s7,-1602 # 8170 <malloc+0x2136>
    int free0 = countfree();
    int free1 = 0;
    ...
    5800:	780080e7          	jalr	1920(ra) # 5f7c <printf>
    int free0 = countfree();
    ...
    5854:	72c080e7          	jalr	1836(ra) # 5f7c <printf>
      if(continuous != 2) {
    ...
    5864:	71c080e7          	jalr	1820(ra) # 5f7c <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58d2:	90a58593          	addi	a1,a1,-1782 # 81d8 <malloc+0x219e>
    ...
    58e8:	94c58593          	addi	a1,a1,-1716 # 8230 <malloc+0x21f6>
    ...
    58fe:	92e58593          	addi	a1,a1,-1746 # 8228 <malloc+0x21ee>
  ...
  int continuous = 0;
    ...
    592a:	8ba50513          	addi	a0,a0,-1862 # 81e0 <malloc+0x21a6>
    592e:	00000097          	auipc	ra,0x0
    5932:	64e080e7          	jalr	1614(ra) # 5f7c <printf>
    exit(1);
    5936:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5956:	8be50513          	addi	a0,a0,-1858 # 8210 <malloc+0x21d6>
    595a:	00000097          	auipc	ra,0x0
    595e:	622080e7          	jalr	1570(ra) # 5f7c <printf>
  exit(0);
    5962:	4501                	li	a0,0
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5cba:	f5e080e7          	jalr	-162(ra) # 5c14 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    5cce:	f04a                	sd	s2,32(sp)
    5cd0:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5cd6:	c299                	beqz	a3,5cdc <printint+0x16>
    5cd8:	0805c863          	bltz	a1,5d68 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5cdc:	2581                	sext.w	a1,a1
  neg = 0;
    5cde:	4881                	li	a7,0
    5ce0:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5ce6:	2601                	sext.w	a2,a2
    5ce8:	00003517          	auipc	a0,0x3
    5cec:	8b850513          	addi	a0,a0,-1864 # 85a0 <digits>
    5cf0:	883a                	mv	a6,a4
    5cf2:	2705                	addiw	a4,a4,1
    5cf4:	02c5f7bb          	remuw	a5,a1,a2
    5cf8:	1782                	slli	a5,a5,0x20
    5cfa:	9381                	srli	a5,a5,0x20
    5cfc:	97aa                	add	a5,a5,a0
    5cfe:	0007c783          	lbu	a5,0(a5)
    5d02:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5d06:	0005879b          	sext.w	a5,a1
    5d0a:	02c5d5bb          	divuw	a1,a1,a2
    5d0e:	0685                	addi	a3,a3,1
    5d10:	fec7f0e3          	bgeu	a5,a2,5cf0 <printint+0x2a>
  if(neg)
    5d14:	00088b63          	beqz	a7,5d2a <printint+0x64>
    buf[i++] = '-';
    5d18:	fd040793          	addi	a5,s0,-48
    5d1c:	973e                	add	a4,a4,a5
    5d1e:	02d00793          	li	a5,45
    5d22:	fef70823          	sb	a5,-16(a4)
    5d26:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d2a:	02e05863          	blez	a4,5d5a <printint+0x94>
    5d2e:	fc040793          	addi	a5,s0,-64
    5d32:	00e78933          	add	s2,a5,a4
    5d36:	fff78993          	addi	s3,a5,-1
    5d3a:	99ba                	add	s3,s3,a4
    5d3c:	377d                	addiw	a4,a4,-1
    5d3e:	1702                	slli	a4,a4,0x20
    5d40:	9301                	srli	a4,a4,0x20
    5d42:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d46:	fff94583          	lbu	a1,-1(s2)
    5d4a:	8526                	mv	a0,s1
    5d4c:	00000097          	auipc	ra,0x0
    5d50:	f58080e7          	jalr	-168(ra) # 5ca4 <putc>
  while(--i >= 0)
    5d54:	197d                	addi	s2,s2,-1
    5d56:	ff3918e3          	bne	s2,s3,5d46 <printint+0x80>
}
    5d5a:	70e2                	ld	ra,56(sp)
    5d5c:	7442                	ld	s0,48(sp)
    5d5e:	74a2                	ld	s1,40(sp)
    5d60:	7902                	ld	s2,32(sp)
    5d62:	69e2                	ld	s3,24(sp)
    5d64:	6121                	addi	sp,sp,64
    5d66:	8082                	ret
    x = -xx;
    5d68:	40b005bb          	negw	a1,a1
    neg = 1;
    5d6c:	4885                	li	a7,1
    x = -xx;
    5d6e:	bf8d                	j	5ce0 <printint+0x1a>

0000000000005d70 <vprintf>:
}
...
{
    5d70:	7119                	addi	sp,sp,-128
    5d72:	fc86                	sd	ra,120(sp)
    5d74:	f8a2                	sd	s0,112(sp)
    5d76:	f4a6                	sd	s1,104(sp)
    5d78:	f0ca                	sd	s2,96(sp)
    5d7a:	ecce                	sd	s3,88(sp)
    5d7c:	e8d2                	sd	s4,80(sp)
    5d7e:	e4d6                	sd	s5,72(sp)
    5d80:	e0da                	sd	s6,64(sp)
    5d82:	fc5e                	sd	s7,56(sp)
    5d84:	f862                	sd	s8,48(sp)
    5d86:	f466                	sd	s9,40(sp)
    5d88:	f06a                	sd	s10,32(sp)
    5d8a:	ec6e                	sd	s11,24(sp)
    5d8c:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5d8e:	0005c903          	lbu	s2,0(a1)
    5d92:	18090f63          	beqz	s2,5f30 <vprintf+0x1c0>
    5d96:	8aaa                	mv	s5,a0
    5d98:	8b32                	mv	s6,a2
    5d9a:	00158493          	addi	s1,a1,1
  state = 0;
    5d9e:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5da0:	02500a13          	li	s4,37
      if(c == 'd'){
    5da4:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5da8:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5dac:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5db0:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5db4:	00002b97          	auipc	s7,0x2
    5db8:	7ecb8b93          	addi	s7,s7,2028 # 85a0 <digits>
    5dbc:	a839                	j	5dda <vprintf+0x6a>
        putc(fd, c);
    5dbe:	85ca                	mv	a1,s2
    5dc0:	8556                	mv	a0,s5
    5dc2:	00000097          	auipc	ra,0x0
    5dc6:	ee2080e7          	jalr	-286(ra) # 5ca4 <putc>
    5dca:	a019                	j	5dd0 <vprintf+0x60>
    } else if(state == '%'){
    5dcc:	01498f63          	beq	s3,s4,5dea <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5dd0:	0485                	addi	s1,s1,1
    5dd2:	fff4c903          	lbu	s2,-1(s1)
    5dd6:	14090d63          	beqz	s2,5f30 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5dda:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5dde:	fe0997e3          	bnez	s3,5dcc <vprintf+0x5c>
      if(c == '%'){
    5de2:	fd479ee3          	bne	a5,s4,5dbe <vprintf+0x4e>
        state = '%';
    5de6:	89be                	mv	s3,a5
    5de8:	b7e5                	j	5dd0 <vprintf+0x60>
      if(c == 'd'){
    5dea:	05878063          	beq	a5,s8,5e2a <vprintf+0xba>
      } else if(c == 'l') {
    5dee:	05978c63          	beq	a5,s9,5e46 <vprintf+0xd6>
      } else if(c == 'x') {
    5df2:	07a78863          	beq	a5,s10,5e62 <vprintf+0xf2>
      } else if(c == 'p') {
    5df6:	09b78463          	beq	a5,s11,5e7e <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5dfa:	07300713          	li	a4,115
    5dfe:	0ce78663          	beq	a5,a4,5eca <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5e02:	06300713          	li	a4,99
    5e06:	0ee78e63          	beq	a5,a4,5f02 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5e0a:	11478863          	beq	a5,s4,5f1a <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5e16:	e92080e7          	jalr	-366(ra) # 5ca4 <putc>
        putc(fd, c);
    5e1a:	85ca                	mv	a1,s2
    5e1c:	8556                	mv	a0,s5
    5e1e:	00000097          	auipc	ra,0x0
    5e22:	e86080e7          	jalr	-378(ra) # 5ca4 <putc>
      }
      state = 0;
    5e26:	4981                	li	s3,0
    5e28:	b765                	j	5dd0 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5e3c:	e8e080e7          	jalr	-370(ra) # 5cc6 <printint>
    5e40:	8b4a                	mv	s6,s2
      state = 0;
    5e42:	4981                	li	s3,0
    5e44:	b771                	j	5dd0 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5e58:	e72080e7          	jalr	-398(ra) # 5cc6 <printint>
    5e5c:	8b4a                	mv	s6,s2
      state = 0;
    5e5e:	4981                	li	s3,0
    5e60:	bf85                	j	5dd0 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5e74:	e56080e7          	jalr	-426(ra) # 5cc6 <printint>
    5e78:	8b4a                	mv	s6,s2
      state = 0;
    5e7a:	4981                	li	s3,0
    5e7c:	bf91                	j	5dd0 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e7e:	008b0793          	addi	a5,s6,8
    5e82:	f8f43423          	sd	a5,-120(s0)
    5e86:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e8a:	03000593          	li	a1,48
    5e8e:	8556                	mv	a0,s5
    5e90:	00000097          	auipc	ra,0x0
    5e94:	e14080e7          	jalr	-492(ra) # 5ca4 <putc>
  putc(fd, 'x');
    5e98:	85ea                	mv	a1,s10
    5e9a:	8556                	mv	a0,s5
    5e9c:	00000097          	auipc	ra,0x0
    5ea0:	e08080e7          	jalr	-504(ra) # 5ca4 <putc>
    5ea4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5ea6:	03c9d793          	srli	a5,s3,0x3c
    5eaa:	97de                	add	a5,a5,s7
    5eac:	0007c583          	lbu	a1,0(a5)
    5eb0:	8556                	mv	a0,s5
    5eb2:	00000097          	auipc	ra,0x0
    5eb6:	df2080e7          	jalr	-526(ra) # 5ca4 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5eba:	0992                	slli	s3,s3,0x4
    5ebc:	397d                	addiw	s2,s2,-1
    5ebe:	fe0914e3          	bnez	s2,5ea6 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5ec2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5ec6:	4981                	li	s3,0
    5ec8:	b721                	j	5dd0 <vprintf+0x60>
        s = va_arg(ap, char*);
    5eca:	008b0993          	addi	s3,s6,8
    5ece:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5ed2:	02090163          	beqz	s2,5ef4 <vprintf+0x184>
        while(*s != 0){
    5ed6:	00094583          	lbu	a1,0(s2)
    5eda:	c9a1                	beqz	a1,5f2a <vprintf+0x1ba>
          putc(fd, *s);
    5edc:	8556                	mv	a0,s5
    5ede:	00000097          	auipc	ra,0x0
    5ee2:	dc6080e7          	jalr	-570(ra) # 5ca4 <putc>
          s++;
    5ee6:	0905                	addi	s2,s2,1
        while(*s != 0){
    5ee8:	00094583          	lbu	a1,0(s2)
    5eec:	f9e5                	bnez	a1,5edc <vprintf+0x16c>
        s = va_arg(ap, char*);
    5eee:	8b4e                	mv	s6,s3
      state = 0;
    5ef0:	4981                	li	s3,0
    5ef2:	bdf9                	j	5dd0 <vprintf+0x60>
          s = "(null)";
    5ef4:	00002917          	auipc	s2,0x2
    5ef8:	6a490913          	addi	s2,s2,1700 # 8598 <malloc+0x255e>
        while(*s != 0){
    5efc:	02800593          	li	a1,40
    5f00:	bff1                	j	5edc <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5f02:	008b0913          	addi	s2,s6,8
    5f06:	000b4583          	lbu	a1,0(s6)
    5f0a:	8556                	mv	a0,s5
    5f0c:	00000097          	auipc	ra,0x0
    5f10:	d98080e7          	jalr	-616(ra) # 5ca4 <putc>
    5f14:	8b4a                	mv	s6,s2
      state = 0;
    5f16:	4981                	li	s3,0
    5f18:	bd65                	j	5dd0 <vprintf+0x60>
        putc(fd, c);
    5f1a:	85d2                	mv	a1,s4
    5f1c:	8556                	mv	a0,s5
    5f1e:	00000097          	auipc	ra,0x0
    5f22:	d86080e7          	jalr	-634(ra) # 5ca4 <putc>
      state = 0;
    5f26:	4981                	li	s3,0
    5f28:	b565                	j	5dd0 <vprintf+0x60>
        s = va_arg(ap, char*);
    5f2a:	8b4e                	mv	s6,s3
      state = 0;
    5f2c:	4981                	li	s3,0
    5f2e:	b54d                	j	5dd0 <vprintf+0x60>
    }
  }
}
    5f30:	70e6                	ld	ra,120(sp)
    5f32:	7446                	ld	s0,112(sp)
    5f34:	74a6                	ld	s1,104(sp)
    5f36:	7906                	ld	s2,96(sp)
    5f38:	69e6                	ld	s3,88(sp)
    5f3a:	6a46                	ld	s4,80(sp)
    5f3c:	6aa6                	ld	s5,72(sp)
    5f3e:	6b06                	ld	s6,64(sp)
    5f40:	7be2                	ld	s7,56(sp)
    5f42:	7c42                	ld	s8,48(sp)
    5f44:	7ca2                	ld	s9,40(sp)
    5f46:	7d02                	ld	s10,32(sp)
    5f48:	6de2                	ld	s11,24(sp)
    5f4a:	6109                	addi	sp,sp,128
    5f4c:	8082                	ret

0000000000005f4e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f4e:	715d                	addi	sp,sp,-80
    5f50:	ec06                	sd	ra,24(sp)
    5f52:	e822                	sd	s0,16(sp)
    5f54:	1000                	addi	s0,sp,32
    5f56:	e010                	sd	a2,0(s0)
    5f58:	e414                	sd	a3,8(s0)
    5f5a:	e818                	sd	a4,16(s0)
    5f5c:	ec1c                	sd	a5,24(s0)
    5f5e:	03043023          	sd	a6,32(s0)
    5f62:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f66:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f6a:	8622                	mv	a2,s0
    5f6c:	00000097          	auipc	ra,0x0
    5f70:	e04080e7          	jalr	-508(ra) # 5d70 <vprintf>
}
    5f74:	60e2                	ld	ra,24(sp)
    5f76:	6442                	ld	s0,16(sp)
    5f78:	6161                	addi	sp,sp,80
    5f7a:	8082                	ret

0000000000005f7c <printf>:

void
printf(const char *fmt, ...)
{
    5f7c:	711d                	addi	sp,sp,-96
    5f7e:	ec06                	sd	ra,24(sp)
    5f80:	e822                	sd	s0,16(sp)
    5f82:	1000                	addi	s0,sp,32
    5f84:	e40c                	sd	a1,8(s0)
    5f86:	e810                	sd	a2,16(s0)
    5f88:	ec14                	sd	a3,24(s0)
    5f8a:	f018                	sd	a4,32(s0)
    5f8c:	f41c                	sd	a5,40(s0)
    5f8e:	03043823          	sd	a6,48(s0)
    5f92:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f96:	00840613          	addi	a2,s0,8
    5f9a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f9e:	85aa                	mv	a1,a0
    5fa0:	4505                	li	a0,1
    5fa2:	00000097          	auipc	ra,0x0
    5fa6:	dce080e7          	jalr	-562(ra) # 5d70 <vprintf>
}
    5faa:	60e2                	ld	ra,24(sp)
    5fac:	6442                	ld	s0,16(sp)
    5fae:	6125                	addi	sp,sp,96
    5fb0:	8082                	ret

0000000000005fb2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5fb2:	1141                	addi	sp,sp,-16
    5fb4:	e422                	sd	s0,8(sp)
    5fb6:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fb8:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fbc:	00003797          	auipc	a5,0x3
    5fc0:	4947b783          	ld	a5,1172(a5) # 9450 <freep>
    5fc4:	a805                	j	5ff4 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fc6:	4618                	lw	a4,8(a2)
    5fc8:	9db9                	addw	a1,a1,a4
    5fca:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fce:	6398                	ld	a4,0(a5)
    5fd0:	6318                	ld	a4,0(a4)
    5fd2:	fee53823          	sd	a4,-16(a0)
    5fd6:	a091                	j	601a <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fd8:	ff852703          	lw	a4,-8(a0)
    5fdc:	9e39                	addw	a2,a2,a4
    5fde:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5fe0:	ff053703          	ld	a4,-16(a0)
    5fe4:	e398                	sd	a4,0(a5)
    5fe6:	a099                	j	602c <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fe8:	6398                	ld	a4,0(a5)
    5fea:	00e7e463          	bltu	a5,a4,5ff2 <free+0x40>
    5fee:	00e6ea63          	bltu	a3,a4,6002 <free+0x50>
{
    5ff2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ff4:	fed7fae3          	bgeu	a5,a3,5fe8 <free+0x36>
    5ff8:	6398                	ld	a4,0(a5)
    5ffa:	00e6e463          	bltu	a3,a4,6002 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ffe:	fee7eae3          	bltu	a5,a4,5ff2 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    6002:	ff852583          	lw	a1,-8(a0)
    6006:	6390                	ld	a2,0(a5)
    6008:	02059713          	slli	a4,a1,0x20
    600c:	9301                	srli	a4,a4,0x20
    600e:	0712                	slli	a4,a4,0x4
    6010:	9736                	add	a4,a4,a3
    6012:	fae60ae3          	beq	a2,a4,5fc6 <free+0x14>
    bp->s.ptr = p->s.ptr;
    6016:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    601a:	4790                	lw	a2,8(a5)
    601c:	02061713          	slli	a4,a2,0x20
    6020:	9301                	srli	a4,a4,0x20
    6022:	0712                	slli	a4,a4,0x4
    6024:	973e                	add	a4,a4,a5
    6026:	fae689e3          	beq	a3,a4,5fd8 <free+0x26>
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
    ...
    604c:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    604e:	02051493          	slli	s1,a0,0x20
    6052:	9081                	srli	s1,s1,0x20
    6054:	04bd                	addi	s1,s1,15
    6056:	8091                	srli	s1,s1,0x4
    6058:	0014899b          	addiw	s3,s1,1
    605c:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    608a:	3ca90913          	addi	s2,s2,970 # 9450 <freep>
  if(p == (char*)-1)
    608e:	5afd                	li	s5,-1
    6090:	a88d                	j	6102 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    6092:	0000a797          	auipc	a5,0xa
    6096:	be678793          	addi	a5,a5,-1050 # fc78 <base>
    ...
    60a8:	b7e1                	j	6070 <malloc+0x36>
      if(p->s.size == nunits)
    60aa:	02e48b63          	beq	s1,a4,60e0 <malloc+0xa6>
        p->s.size -= nunits;
    60ae:	4137073b          	subw	a4,a4,s3
    60b2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    60b4:	1702                	slli	a4,a4,0x20
    60b6:	9301                	srli	a4,a4,0x20
    60b8:	0712                	slli	a4,a4,0x4
    60ba:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    60bc:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    60c0:	00003717          	auipc	a4,0x3
    60c4:	38a73823          	sd	a0,912(a4) # 9450 <freep>
      return (void*)(p + 1);
    60c8:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    60cc:	70e2                	ld	ra,56(sp)
    60ce:	7442                	ld	s0,48(sp)
    60d0:	74a2                	ld	s1,40(sp)
    60d2:	7902                	ld	s2,32(sp)
    60d4:	69e2                	ld	s3,24(sp)
    60d6:	6a42                	ld	s4,16(sp)
    60d8:	6aa2                	ld	s5,8(sp)
    60da:	6b02                	ld	s6,0(sp)
    60dc:	6121                	addi	sp,sp,64
    60de:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    60e0:	6398                	ld	a4,0(a5)
    60e2:	e118                	sd	a4,0(a0)
    60e4:	bff1                	j	60c0 <malloc+0x86>
  hp->s.size = nu;
    60e6:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60ea:	0541                	addi	a0,a0,16
    60ec:	00000097          	auipc	ra,0x0
    60f0:	ec6080e7          	jalr	-314(ra) # 5fb2 <free>
  return freep;
    60f4:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60f8:	d971                	beqz	a0,60cc <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60fa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60fc:	4798                	lw	a4,8(a5)
    60fe:	fa9776e3          	bgeu	a4,s1,60aa <malloc+0x70>
    if(p == freep)
    6102:	00093703          	ld	a4,0(s2)
    6106:	853e                	mv	a0,a5
    6108:	fef719e3          	bne	a4,a5,60fa <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    610c:	8552                	mv	a0,s4
    610e:	00000097          	auipc	ra,0x0
    6112:	b6e080e7          	jalr	-1170(ra) # 5c7c <sbrk>
  if(p == (char*)-1)
    6116:	fd5518e3          	bne	a0,s5,60e6 <malloc+0xac>
        return 0;
    611a:	4501                	li	a0,0
    611c:	bf45                	j	60cc <malloc+0x92>
